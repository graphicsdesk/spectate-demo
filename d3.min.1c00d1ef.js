...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../node_modules/d3/dist/d3.min.js":[function(require,module,exports) {
var define;
...
!function (t, n) {
  "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "undefined" != typeof module ? n(exports) : "function" == typeof define && define.amd ? define(["exports"], n) : n((t = "undefined" != typeof globalThis ? globalThis : t || self).d3 = t.d3 || {});
}(this, function (t) {
  "use strict";
  ...
  function e(t) {
    ...
    return 2 !== t.length && (e = function e(n, _e2) {
      return t(n) - _e2;
  ...
  var InternMap = /*#__PURE__*/function (_Map) {
    ...
    _createClass(InternMap, [{
      ...
      value: function get(t) {
        return _get(_getPrototypeOf(InternMap.prototype), "get", this).call(this, v(this, t));
      }
    }, {
      key: "has",
      value: function has(t) {
        return _get(_getPrototypeOf(InternMap.prototype), "has", this).call(this, v(this, t));
      }
    }, {
      key: "set",
      value: function set(t, n) {
        return _get(_getPrototypeOf(InternMap.prototype), "set", this).call(this, _(this, t), n);
      }
    }, {
      key: "delete",
      value: function _delete(t) {
        return _get(_getPrototypeOf(InternMap.prototype), "delete", this).call(this, b(this, t));
      }
    }]);
  ...
  var InternSet = /*#__PURE__*/function (_Set) {
    ...
    _createClass(InternSet, [{
      key: "has",
      value: function has(t) {
        return _get(_getPrototypeOf(InternSet.prototype), "has", this).call(this, v(this, t));
      }
    }, {
      key: "add",
      value: function add(t) {
        return _get(_getPrototypeOf(InternSet.prototype), "add", this).call(this, _(this, t));
      }
    }, {
      key: "delete",
      value: function _delete(t) {
        return _get(_getPrototypeOf(InternSet.prototype), "delete", this).call(this, b(this, t));
      }
    }]);
  ...
  function I(t, n, e) {
    var r = (n - t) / Math.max(0, e),
        ...
        o = r / Math.pow(10, i);
    return i >= 0 ? (o >= R ? 10 : o >= F ? 5 : o >= O ? 2 : 1) * Math.pow(10, i) : -Math.pow(10, -i) / (o >= R ? 10 : o >= F ? 5 : o >= O ? 2 : 1);
  }
  ...
  function B(t, n, e) {
    var r = Math.abs(n - t) / Math.max(0, e),
        ...
        o = r / i;
    return o >= R ? i *= 10 : o >= F ? i *= 5 : o >= O && (i *= 2), n < t ? -i : i;
  }
  ...
  function j() {
    ...
    function r(r) {
      ...
      if (!Array.isArray(h)) {
        ...
        if (n === g && (_Y = Y(s, l, _e9), _Y2 = _slicedToArray(_Y, 2), s = _Y2[0], l = _Y2[1], _Y), (h = U(s, l, _e9))[h.length - 1] >= l) if (_t3 >= l && n === g) {
          var _t4 = I(s, l, _e9);
    ...
    return r.value = function (n) {
      ...
      return arguments.length ? (e = "function" == typeof t ? t : Array.isArray(t) ? q(D.call(t)) : q(t), r) : e;
    }, r;
  }
  ...
  function G(t, n) {
    ...
    for (i = void 0 === i ? z : P(i); r > e;) {
      if (r - e > 600) {
        ...
        G(t, n, Math.max(e, Math.floor(n - _a5 * _c2 / _o5 + _f2)), Math.min(r, Math.floor(n + (_o5 - _a5) * _c2 / _o5 + _f2)), i);
      }
      ...
      for (V(t, e, n), i(t[r], _o4) > 0 && V(t, e, r); _a4 < _u3;) {
        for (V(t, _a4, _u3), ++_a4, --_u3; i(t[_a4], _o4) < 0;) {
          ++_a4;
        }
      ...
      0 === i(t[e], _o4) ? V(t, e, _u3) : (++_u3, V(t, _u3, r)), _u3 <= n && (e = _u3 + 1), n <= _u3 && (r = _u3 - 1);
    }
  ...
  function $(t, n, e) {
    if (t = Float64Array.from( /*#__PURE__*/regeneratorRuntime.mark(function _callee(t, n) {
      ...
      if ((n = +n) <= 0 || r < 2) return X(t);
      if (n >= 1) return H(t);
      var r,
          i = (r - 1) * n,
          o = Math.floor(i),
          a = H(G(t, o).subarray(0, o + 1));
  ...
  function ut(t, n) {
    ...
    try {
      for (_iterator24.s(); !(_step24 = _iterator24.n()).done;) {
        ...
        if (r.has(_n19)) continue;

        var _i8 = void 0,
            _o9 = void 0;

        for (; _e$next = e.next(), _i8 = _e$next.value, _o9 = _e$next.done, _e$next;) {
          var _e$next;
          ...
          if (r.add(_t6), Object.is(_n19, _t6)) break;
        }
      }
    } catch (err) {
      _iterator24.e(err);
  ...
  function yt(t, n) {
    ...
    function h(h) {
      ...
      x = x.merge(x.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), w = w.merge(A), T = T.merge(A.append("line").attr("stroke", "currentColor").attr(s + "2", f * o)), S = S.merge(A.append("text").attr("fill", "currentColor").attr(s, f * g).attr("dy", 1 === t ? "0em" : 3 === t ? "0.71em" : "0.32em")), h !== m && (x = x.transition(h), w = w.transition(h), T = T.transition(h), S = S.transition(h), M = M.transition(h).attr("opacity", st).attr("transform", function (t) {
        ...
        return l(b(t) + c);
      }), T.attr(s + "2", f * o), S.attr(s, f * g).text(p), m.filter(gt).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", 2 === t ? "start" : 4 === t ? "end" : "middle"), m.each(function () {
        this.__axis = b;
      });
    }
  ...
  bt.prototype = _t.prototype = {
    ...
    on: function on(t, n) {
      ...
      if (!(arguments.length < 2)) {
        ...
        for (; ++o < a;) {
          if (e = (t = i[o]).type) r[e] = wt(r[e], t.name, n);else if (null == n) for (e in r) {
  ...
  function Tt(t) {
    var n = t += "",
        e = n.indexOf(":");
    return e >= 0 && "xmlns" !== (n = t.slice(0, e)) && (t = t.slice(e + 1)), At.hasOwnProperty(n) ? {
      space: At[n],
      local: t
    } : t;
  }
  ...
  function jt(t, n, e, r, i, o) {
    for (var a, u = 0, c = n.length, f = o.length; u < f; ++u) {
      (a = n[u]) ? (a.__data__ = o[u], r[u] = a) : e[u] = new Yt(t, o[u]);
    }
  ...
  function Ht(t, n, e, r, i, o, a) {
    ...
    for (u = 0; u < h; ++u) {
      f = a.call(t, o[u], u, o) + "", (c = s.get(f)) ? (r[u] = c, c.__data__ = o[u], s.delete(f)) : e[u] = new Yt(t, o[u]);
    }
  ...
  function On() {
    return new Fn([[document.documentElement]], Rn);
  }

  function Un(t) {
    return "string" == typeof t ? new Fn([[document.querySelector(t)]], [document.documentElement]) : new Fn([[t]], Rn);
  }

  Fn.prototype = On.prototype = _defineProperty({
    constructor: Fn,
    ...
    data: function data(t, n) {
      ...
      return (a = new Fn(a, r))._enter = u, a._exit = c, a;
    },
    enter: function enter() {
      return new Fn(this._enter || this._groups.map(Bt), this._parents);
    },
    exit: function exit() {
      return new Fn(this._exit || this._groups.map(Bt), this._parents);
    },
    ...
    dispatch: function dispatch(t, n) {
      return this.each(("function" == typeof n ? qn : Dn)(t, n));
    }
  ...
  function jn(t, n) {
    if (t = Ln(t), void 0 === n && (n = t.currentTarget), n) {
  ...
  function $n(t) {
    ...
    "onselectstart" in n ? e.on("selectstart.drag", Vn, Xn) : (n.__noselect = n.style.MozUserSelect, n.style.MozUserSelect = "none");
  }

  function Wn(t, n) {
    var e = t.document.documentElement,
        r = Un(t).on("dragstart.drag", null);
    n && (r.on("click.drag", Vn, Xn), setTimeout(function () {
  ...
  function me(t) {
    var n, e;
    return t = (t + "").trim().toLowerCase(), (n = se.exec(t)) ? (e = n[1].length, n = parseInt(n[1], 16), 6 === e ? xe(n) : 3 === e ? new Te(n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | 240 & n, (15 & n) << 4 | 15 & n, 1) : 8 === e ? we(n >> 24 & 255, n >> 16 & 255, n >> 8 & 255, (255 & n) / 255) : 4 === e ? we(n >> 12 & 15 | n >> 8 & 240, n >> 8 & 15 | n >> 4 & 240, n >> 4 & 15 | 240 & n, ((15 & n) << 4 | 15 & n) / 255) : null) : (n = le.exec(t)) ? new Te(n[1], n[2], n[3], 1) : (n = he.exec(t)) ? new Te(255 * n[1] / 100, 255 * n[2] / 100, 255 * n[3] / 100, 1) : (n = de.exec(t)) ? we(n[1], n[2], n[3], n[4]) : (n = pe.exec(t)) ? we(255 * n[1] / 100, 255 * n[2] / 100, 255 * n[3] / 100, n[4]) : (n = ge.exec(t)) ? Ne(n[1], n[2] / 100, n[3] / 100, 1) : (n = ye.exec(t)) ? Ne(n[1], n[2] / 100, n[3] / 100, n[4]) : ve.hasOwnProperty(t) ? xe(ve[t]) : "transparent" === t ? new Te(NaN, NaN, NaN, 0) : null;
  }
  ...
  function Me(t) {
    return t instanceof ie || (t = me(t)), t ? new Te((t = t.rgb()).r, t.g, t.b, t.opacity) : new Te();
  }
  ...
  function Ne(t, n, e, r) {
    return r <= 0 ? t = n = e = NaN : e <= 0 || e >= 1 ? t = n = NaN : n <= 0 && (t = NaN), new ze(t, n, e, r);
  }

  function Ce(t) {
    if (t instanceof ze) return new ze(t.h, t.s, t.l, t.opacity);
    if (t instanceof ie || (t = me(t)), !t) return new ze();
    ...
    var n = (t = t.rgb()).r / 255,
        ...
        u = o - i,
        c = (o + i) / 2;
    return u ? (a = n === o ? (e - r) / u + 6 * (e < r) : e === o ? (r - n) / u + 2 : (n - e) / u + 4, u /= c < .5 ? o + i : 2 - o - i, a *= 60) : u = c > 0 && c < 1 ? 0 : a, new ze(a, u, c, t.opacity);
  }
  ...
  ee(ie, me, {
    ...
    brighter: function brighter(t) {
      return t = null == t ? ae : Math.pow(ae, t), new Te(this.r * t, this.g * t, this.b * t, this.opacity);
    },
    darker: function darker(t) {
      return t = null == t ? oe : Math.pow(oe, t), new Te(this.r * t, this.g * t, this.b * t, this.opacity);
    },
    rgb: function rgb() {
      return this;
    },
    ...
    brighter: function brighter(t) {
      return t = null == t ? ae : Math.pow(ae, t), new ze(this.h, this.s, this.l * t, this.opacity);
    },
    darker: function darker(t) {
  ...
  function Ye(t) {
    if (t instanceof je) return new je(t.l, t.a, t.b, t.opacity);
    if (t instanceof Ze) return Ke(t);
    ...
    var n,
        ...
        i = Ve(t.g),
        o = Ve(t.b),
        a = He((.2225045 * r + .7168786 * i + .0606169 * o) / 1);
    return r === i && i === o ? n = e = a : (n = He((.4360747 * r + .3850649 * i + .1430804 * o) / Fe), e = He((.0139322 * r + .0971045 * i + .7141733 * o) / Oe)), new je(116 * a - 16, 500 * (n - a), 200 * (a - e), t.opacity);
  }
  ...
  function $e(t) {
    ...
    if (t instanceof je || (t = Ye(t)), 0 === t.a && 0 === t.b) return new Ze(NaN, 0 < t.l && t.l < 100 ? 0 : NaN, t.l, t.opacity);
    var n = Math.atan2(t.b, t.a) * Re;
  ...
  function Ke(t) {
    if (isNaN(t.h)) return new je(t.l, 0, 0, t.opacity);
    var n = t.h * qe;
  ...
  ee(je, Le, re(ie, {
    ...
    rgb: function rgb() {
      ...
      return new Te(Ge(3.1338561 * (n = Fe * Xe(n)) - 1.6168667 * (t = 1 * Xe(t)) - .4906146 * (e = Oe * Xe(e))), Ge(-.9787684 * n + 1.9161415 * t + .033454 * e), Ge(.0719453 * n - .2289914 * t + 1.4052427 * e), this.opacity);
    }
  })), ee(Ze, We, re(ie, {
    brighter: function brighter(t) {
  ...
  function ar(t) {
    if (t instanceof cr) return new cr(t.h, t.s, t.l, t.opacity);
    t instanceof Te || (t = Me(t));
    var n = t.r / 255,
        e = t.g / 255,
        r = t.b / 255,
  ...
  ee(cr, ur, re(ie, {
    brighter: function brighter(t) {
      return t = null == t ? ae : Math.pow(ae, t), new cr(this.h, this.s, this.l * t, this.opacity);
    },
    darker: function darker(t) {
      return t = null == t ? oe : Math.pow(oe, t), new cr(this.h, this.s, this.l * t, this.opacity);
    },
    rgb: function rgb() {
      var t = isNaN(this.h) ? 0 : (this.h + 120) * qe,
          n = +this.l,
  ...
  function _r(t) {
    return function (n) {
      ...
      for (e = 0; e < i; ++e) {
        r = Ae(n[e]), o[e] = r.r || 0, a[e] = r.g || 0, u[e] = r.b || 0;
      }
  ...
  function Nr(t, n) {
    var e,
        r,
        i,
        o = Er.lastIndex = kr.lastIndex = 0,
        a = -1,
        u = [],
        c = [];

    for (t += "", n += ""; (e = Er.exec(t)) && (r = kr.exec(n));) {
  ...
  function Cr(t, n) {
    ...
    return null == n || "boolean" === r ? hr(n) : ("number" === r ? Tr : "string" === r ? (e = me(n)) ? (n = e, vr) : Nr : n instanceof me ? vr : n instanceof Date ? Ar : wr(n) ? xr : Array.isArray(n) ? Mr : "function" != typeof n.valueOf && "function" != typeof n.toString || isNaN(n) ? Sr : Tr)(t, n);
  }
  ...
  var Or = Fr(function (t) {
    var n = new ("function" == typeof DOMMatrix ? DOMMatrix : WebKitCSSMatrix)(t + "");
    return n.isIdentity ? qr : Rr(n.a, n.b, n.c, n.d, n.e, n.f);
  }, "px, ", "px)", "deg)"),
      Ur = Fr(function (t) {
    return null == t ? qr : (zr || (zr = document.createElementNS("http://www.w3.org/2000/svg", "g")), zr.setAttribute("transform", t), (t = zr.transform.baseVal.consolidate()) ? Rr((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f) : qr);
  }, ", ", ")", ")");
  ...
  var Kr,
      ...
      ri = 0,
      ii = 0,
      oi = "object" == (typeof performance === "undefined" ? "undefined" : _typeof(performance)) && performance.now ? performance : Date,
      ai = "object" == (typeof window === "undefined" ? "undefined" : _typeof(window)) && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function (t) {
    setTimeout(t, 17);
  };

  function ui() {
    return ri || (ai(ci), ri = oi.now() + ii);
  }
  ...
  function li() {
    ...
    for (var t, n = Kr; n;) {
      (t = ri - n._time) >= 0 && n._call.call(void 0, t), n = n._next;
    }
  ...
  function hi() {
    ...
    try {
      ...
      Jr = 0, function () {
        ...
        for (; e;) {
          e._call ? (r > e._time && (r = e._time), t = e, e = e._next) : (n = e._next, e._next = null, e = t ? t._next = n : Kr = n);
        }
  ...
  function pi(t) {
    Jr || (ti && (ti = clearTimeout(ti)), t - ri > 24 ? (t < 1 / 0 && (ti = setTimeout(hi, t - oi.now() - ii)), ni && (ni = clearInterval(ni))) : (ni || (ei = oi.now(), ni = setInterval(di, 1e3)), Jr = 1, ai(hi)));
  }
  ...
  function gi(t, n, e) {
    ...
    restart: function restart(t, n, e) {
      ...
      e = (null == e ? ui() : +e) + (null == n ? 0 : +n), this._next || Qr === this || (Qr ? Qr._next = this : Kr = this, Qr = this), this._call = t, this._time = e, pi();
    },
    stop: function stop() {
  ...
  function Si(t, n) {
    var e;
    return ("number" == typeof n ? Tr : n instanceof me ? vr : (e = me(n)) ? (n = e, vr) : Nr)(t, n);
  }
  ...
  var Ji = On.prototype;
  Zi.prototype = Ki.prototype = _defineProperty({
    constructor: Zi,
    select: function select(t) {
      var n = this._name,
          e = this._id;
      ...
      for (var r = this._groups, i = r.length, o = new Array(i), a = 0; a < i; ++a) {
        for (var u, c, f = r[a], s = f.length, l = o[a] = new Array(s), h = 0; h < s; ++h) {
          (u = f[h]) && (c = t.call(u, u.__data__, h, f)) && ("__data__" in u && (c.__data__ = u.__data__), l[h] = c, _i(l[h], n, e, h, l, xi(u, e)));
        }
      }
    ...
    attrTween: function attrTween(t, n) {
      ...
      if ("function" != typeof n) throw new Error();
      var r = Tt(t);
      return this.tween(e, (r.local ? Ri : Fi)(r, n));
    },
    style: function style(t, n, e) {
      ...
      return null == n ? this.styleTween(t, function (t, n) {
        ...
        return function () {
          var a = on(this, t),
              u = e(this),
              c = u + "";
          return null == u && (this.style.removeProperty(t), c = u = on(this, t)), a === c ? null : a === r && c === i ? o : (i = c, o = n(r = a, u));
        };
  ...
  On.prototype.interrupt = function (t) {
    ...
    var n, e;
    t instanceof Zi ? (n = t._id, t = t._name) : (n = Qi(), (e = Mo).time = ui(), t = null == t ? null : t + "");
    ...
    function h(e) {
      if ((!n || e.touches) && r.apply(this, arguments)) {
        var i,
            ...
            m = "selection" === (o && e.metaKey ? b = "overlay" : b) ? Co : o && e.altKey ? Do : zo,
            x = t === Bo ? null : Xo[b],
            w = t === Io ? null : Go[b],
            M = Ko(_),
            A = M.extent,
          ...
          var n = t.identifier;
          return (t = jn(t, _)).point0 = t.slice(), t.identifier = n, t;
        });
        ...
        if ("overlay" === b) {
          ...
          M.selection = T = [[i = t === Bo ? S : Fo(_n21[0][0], _n21[1][0]), u = t === Io ? E : Fo(_n21[0][1], _n21[1][1])], [l = t === Bo ? k : Ro(_n21[0][0], _n21[1][0]), d = t === Io ? N : Ro(_n21[0][1], _n21[1][1])]], D.length > 1 && I(e);
        } else i = T[0][0], u = T[0][1], l = T[1][0], d = T[1][1];

        a = i, c = u, h = l, p = d;
        var R = Un(_).attr("pointer-events", "none"),
            F = R.selectAll(".overlay").attr("cursor", Lo[b]);
        if (e.touches) q.moved = U, q.ended = B;else {
          var O = Un(e.view).on("mousemove.brush", U, !0).on("mouseup.brush", B, !0);
          o && O.on("keydown.brush", Y, !0).on("keyup.brush", L, !0), $n(e.view);
        }
      ...
      function U(t) {
          ...
          for (_iterator26.s(); !(_step26 = _iterator26.n()).done;) {
            ...
            try {
              for (_iterator28.s(); !(_step28 = _iterator28.n()).done;) {
                var _t8 = _step28.value;
                _t8.identifier === _n22.identifier && (_t8.cur = jn(_n22, _));
              }
            } catch (err) {
              _iterator28.e(err);
            } finally {
        ...
        if (z && !y && !v && 1 === D.length) {
          var _t7 = D[0];
          qo(_t7.cur[0] - _t7[0]) > qo(_t7.cur[1] - _t7[1]) ? v = !0 : y = !0;
        }
        ...
        try {
          for (_iterator27.s(); !(_step27 = _iterator27.n()).done;) {
            var _t9 = _step27.value;
            _t9.cur && (_t9[0] = _t9.cur[0], _t9[1] = _t9.cur[1]);
          }
        } catch (err) {
          _iterator27.e(err);
        } finally {
      ...
      function I(t) {
        ...
        switch (C = n[0] - e[0], P = n[1] - e[1], m) {
          case Po:
          case Co:
            x && (C = Ro(S - i, Fo(k - l, C)), a = i + C, h = l + C), w && (P = Ro(E - u, Fo(N - d, P)), c = u + P, p = d + P);
            break;

          case zo:
            D[1] ? (x && (a = Ro(S, Fo(k, D[0][0])), h = Ro(S, Fo(k, D[1][0])), x = 1), w && (c = Ro(E, Fo(N, D[0][1])), p = Ro(E, Fo(N, D[1][1])), w = 1)) : (x < 0 ? (C = Ro(S - i, Fo(k - i, C)), a = i + C, h = l) : x > 0 && (C = Ro(S - l, Fo(k - l, C)), a = i, h = l + C), w < 0 ? (P = Ro(E - u, Fo(N - u, P)), c = u + P, p = d) : w > 0 && (P = Ro(E - d, Fo(N - d, P)), c = u, p = d + P));
            break;

          case Do:
            x && (a = Ro(S, Fo(k, i - C * x)), h = Ro(S, Fo(k, l + C * x))), w && (c = Ro(E, Fo(N, u - P * w)), p = Ro(E, Fo(N, d + P * w)));
        }
      ...
      function B(t) {
        ...
        } else Wn(t.view, g), O.on("keydown.brush keyup.brush mousemove.brush mouseup.brush", null);

        R.attr("pointer-events", "all"), F.attr("cursor", Lo.overlay), M.selection && (T = M.selection), Qo(T) && (M.selection = null, f.call(_)), q.end(t, m.name);
      }
      ...
      function Y(t) {
        switch (t.keyCode) {
          ...
          case 18:
            m === zo && (x && (l = h - C * x, i = a + C * x), w && (d = p - P * w, u = c + P * w), m = Do, I(t));
            break;

          case 32:
            m !== zo && m !== Do || (x < 0 ? l = h - C : x > 0 && (i = a - C), w < 0 ? d = p - P : w > 0 && (u = c - P), m = Po, F.attr("cursor", Lo.selection), I(t));
            break;
      ...
      function L(t) {
        switch (t.keyCode) {
          ...
          case 18:
            m === Do && (x < 0 ? l = h : x > 0 && (i = a), w < 0 ? d = p : w > 0 && (u = c), m = zo, I(t));
            break;

          case 32:
            m === Po && (t.altKey ? (x && (l = h - C * x, i = a + C * x), w && (d = p - P * w, u = c + P * w), m = Do) : (x < 0 ? l = h : x > 0 && (i = a), w < 0 ? d = p : w > 0 && (u = c), m = zo), F.attr("cursor", Lo[b]), I(t));
            break;
    ...
    return c.move = function (n, e, r) {
      n.tween ? n.on("start.brush", function (t) {
        ...
        var n = this,
            ...
            u = s(n, i).beforestart();
        wi(n), o.selection = null === a ? null : a, f.call(n), u.start(r).brush(r).end(r);
      });
      ...
      return arguments.length ? (e = "function" == typeof t ? t : So(Uo(t)), c) : e;
    }, c.filter = function (t) {
      return arguments.length ? (r = "function" == typeof t ? t : So(!!t), c) : r;
    }, c.touchable = function (t) {
      return arguments.length ? (i = "function" == typeof t ? t : So(!!t), c) : i;
  ...
  function sa(t, n) {
      ...
      u = (d = aa(0, oa - e * c) / d) ? e : oa / c;
      {
        ...
        try {
          var _loop = function _loop() {
            ...
            if (t) {
              var _t10 = ca(1 + ~c, c).filter(function (t) {
              ...
              var _iterator30 = _createForOfIteratorHelper(_t10),
                  _step30;
              ...
              var _t11 = ca(0, c).filter(function (t) {
                return a[e * c + t] || a[t * c + e];
              });

              i && _t11.sort(function (t, n) {
                return i(a[e * c + t], a[e * c + n]);
              });

              var _iterator31 = _createForOfIteratorHelper(_t11),
                  _step31;
              ...
              try {
                for (_iterator31.s(); !(_step31 = _iterator31.n()).done;) {
                  ...
                  if (e < _r17 ? (_t12 = l[e * c + _r17] || (l[e * c + _r17] = {
                    source: null,
                    target: null
                  }), _t12.source = {
                    index: e,
                    ...
                    endAngle: _n24 += a[e * c + _r17] * d,
                    value: a[e * c + _r17]
                  }, e === _r17 && (_t12.source = _t12.target)), _t12.source && _t12.target && _t12.source.value < _t12.target.value) {
                    var _n25 = _t12.source;
                    _t12.source = _t12.target, _t12.target = _n25;
                  }
                }
              } catch (err) {
                _iterator31.e(err);
    ...
    return a.padAngle = function (t) {
      return arguments.length ? (e = aa(0, t), a) : e;
    }, a.sortGroups = function (t) {
      return arguments.length ? (r = t, a) : r;
    }, a.sortSubgroups = function (t) {
      return arguments.length ? (i = t, a) : i;
    }, a.sortChords = function (t) {
      return arguments.length ? (null == t ? o = null : (o = fa(t))._ = t, a) : o && o._;
    }, a;
  }
  ...
  ga.prototype = ya.prototype = {
    ...
    arcTo: function arcTo(t, n, e, r, i) {
      ...
      if (null === this._x1) this._ += "M" + (this._x1 = t) + "," + (this._y1 = n);else if (l > da) {
        if (Math.abs(s * u - c * f) > da && i) {
          ...
          Math.abs(b - 1) > da && (this._ += "L" + (t + b * f) + "," + (n + b * s)), this._ += "A" + i + "," + i + ",0,0," + +(s * h > f * d) + "," + (this._x1 = t + m * u) + "," + (this._y1 = n + m * c);
    ...
    arc: function arc(t, n, e, r, i, o) {
      ...
      null === this._x1 ? this._ += "M" + c + "," + f : (Math.abs(this._x1 - c) > da || Math.abs(this._y1 - f) > da) && (this._ += "L" + c + "," + f), e && (l < 0 && (l = l % ha + ha), l > pa ? this._ += "A" + e + "," + e + ",0,1," + s + "," + (t - a) + "," + (n - u) + "A" + e + "," + e + ",0,1," + s + "," + (this._x1 = c) + "," + (this._y1 = f) : l > da && (this._ += "A" + e + "," + e + ",0," + +(l >= la) + "," + s + "," + (this._x1 = t + e * Math.cos(i)) + "," + (this._y1 = n + e * Math.sin(i))));
    },
  ...
  function Sa(t) {
    ...
    function f() {
      ...
      if (c || (c = f = ya()), h > ua && (ta(y - g) > 2 * h + ua ? y > g ? (g += h, y -= h) : (g -= h, y += h) : g = y = (g + y) / 2, ta(b - _) > 2 * h + ua ? b > _ ? (_ += h, b -= h) : (_ -= h, b += h) : _ = b = (_ + b) / 2), c.moveTo(p * na(g), p * ea(g)), c.arc(0, 0, p, g, y), g !== _ || y !== b) if (t) {
        var m = +t.apply(this, arguments),
            x = v - m,
            w = (_ + b) / 2;
        c.quadraticCurveTo(0, 0, x * na(_), x * ea(_)), c.lineTo(v * na(w), v * ea(w)), c.lineTo(x * na(b), x * ea(b));
      } else c.quadraticCurveTo(0, 0, v * na(_), v * ea(_)), c.arc(0, 0, v, _, b);
      if (c.quadraticCurveTo(0, 0, p * na(g), p * ea(g)), c.closePath(), f) return c = null, f + "" || null;
    }

    return t && (f.headRadius = function (n) {
      return arguments.length ? (t = "function" == typeof n ? n : _a(+n), f) : t;
    }), f.radius = function (t) {
      return arguments.length ? (r = i = "function" == typeof t ? t : _a(+t), f) : r;
    }, f.sourceRadius = function (t) {
      return arguments.length ? (r = "function" == typeof t ? t : _a(+t), f) : r;
    }, f.targetRadius = function (t) {
      return arguments.length ? (i = "function" == typeof t ? t : _a(+t), f) : i;
    }, f.startAngle = function (t) {
      return arguments.length ? (o = "function" == typeof t ? t : _a(+t), f) : o;
    }, f.endAngle = function (t) {
      return arguments.length ? (a = "function" == typeof t ? t : _a(+t), f) : a;
    }, f.padAngle = function (t) {
      return arguments.length ? (u = "function" == typeof t ? t : _a(+t), f) : u;
    }, f.source = function (t) {
  ...
  var qa = [[], [[[1, 1.5], [.5, 1]]], [[[1.5, 1], [1, 1.5]]], [[[1.5, 1], [.5, 1]]], [[[1, .5], [1.5, 1]]], [[[1, 1.5], [.5, 1]], [[1, .5], [1.5, 1]]], [[[1, .5], [1, 1.5]]], [[[1, .5], [.5, 1]]], [[[.5, 1], [1, .5]]], [[[1, 1.5], [1, .5]]], [[[.5, 1], [1, .5]], [[1.5, 1], [1, 1.5]]], [[[1.5, 1], [1, .5]]], [[[.5, 1], [1.5, 1]]], [[[1, 1.5], [1.5, 1]]], [[[.5, 1], [1, 1.5]]], []];
  ...
  function Ra() {
    ...
    function i(t) {
      ...
      if (Array.isArray(n)) n = n.slice().sort(ka);else {
        var _e12 = g(t),
            _r18 = B(_e12[0], _e12[1], n);

        n = U(Math.floor(_e12[0] / _r18) * _r18, Math.floor(_e12[1] / _r18 - 1) * _r18, n);
      }
    ...
    function o(e, i) {
      ...
      return function (e, r, i) {
        var o,
            ...
            h = new Array(),
            d = new Array();
        o = u = -1, f = e[0] >= r, qa[f << 1].forEach(p);

        for (; ++o < t - 1;) {
          c = f, f = e[o + 1] >= r, qa[c | f << 1].forEach(p);
        }

        qa[f << 0].forEach(p);

        for (; ++u < n - 1;) {
          for (o = -1, f = e[u * t + t] >= r, s = e[u * t] >= r, qa[f << 1 | s << 2].forEach(p); ++o < t - 1;) {
            c = f, f = e[u * t + t + o + 1] >= r, l = s, s = e[u * t + o + 1] >= r, qa[c | f << 1 | s << 2 | l << 3].forEach(p);
          }

          qa[f | s << 3].forEach(p);
        }

        o = -1, s = e[u * t] >= r, qa[s << 2].forEach(p);

        for (; ++o < t - 1;) {
          l = s, s = e[u * t + o + 1] >= r, qa[s << 2 | l << 3].forEach(p);
        }
        ...
        for (var n, e = 0, r = o.length; e < r; ++e) {
          if (-1 !== Ca((n = o[e])[0], t)) return void n.push(t);
        }
      }), {
        type: "MultiPolygon",
        value: i,
    ...
    return i.contour = o, i.size = function (e) {
      ...
      return arguments.length ? (e = "function" == typeof t ? t : Array.isArray(t) ? Na(Ea.call(t)) : Na(t), i) : e;
    }, i.smooth = function (t) {
      return arguments.length ? (r = t ? u : Da, i) : r === u;
    }, i;
  }
  ...
  function Wa(t, n, e, r, i, o) {
    ...
    return Math.abs(c) >= 33306690738754716e-32 * f ? c : -function (t, n, e, r, i, o, a) {
      ...
      var T = t - i,
          ...
          E = n - o,
          k = r - o;
      m = T * k, h = Ya * T, d = h - (h - T), p = T - d, h = Ya * k, g = h - (h - k), y = k - g, x = p * y - (m - d * g - p * g - d * y), w = E * S, h = Ya * E, d = h - (h - E), p = E - d, h = Ya * S, g = h - (h - S), y = S - g, M = p * y - (w - d * g - p * g - d * y), v = x - M, l = x - v, Ha[0] = x - (v + l) + (l - M), _ = m + v, l = _ - m, b = m - (_ - l) + (v - l), v = b - w, l = b - v, Ha[1] = b - (v + l) + (l - w), A = _ + v, l = A - _, Ha[2] = _ - (A - l) + (v - l), Ha[3] = A;
      ...
      m = u * k, h = Ya * u, d = h - (h - u), p = u - d, h = Ya * k, g = h - (h - k), y = k - g, x = p * y - (m - d * g - p * g - d * y), w = c * S, h = Ya * c, d = h - (h - c), p = c - d, h = Ya * S, g = h - (h - S), y = S - g, M = p * y - (w - d * g - p * g - d * y), v = x - M, l = x - v, $a[0] = x - (v + l) + (l - M), _ = m + v, l = _ - m, b = m - (_ - l) + (v - l), v = b - w, l = b - v, $a[1] = b - (v + l) + (l - w), A = _ + v, l = A - _, $a[2] = _ - (A - l) + (v - l), $a[3] = A;
      var P = La(4, Ha, 4, $a, Xa);
      m = T * s, h = Ya * T, d = h - (h - T), p = T - d, h = Ya * s, g = h - (h - s), y = s - g, x = p * y - (m - d * g - p * g - d * y), w = E * f, h = Ya * E, d = h - (h - E), p = E - d, h = Ya * f, g = h - (h - f), y = f - g, M = p * y - (w - d * g - p * g - d * y), v = x - M, l = x - v, $a[0] = x - (v + l) + (l - M), _ = m + v, l = _ - m, b = m - (_ - l) + (v - l), v = b - w, l = b - v, $a[1] = b - (v + l) + (l - w), A = _ + v, l = A - _, $a[2] = _ - (A - l) + (v - l), $a[3] = A;
      var z = La(P, Xa, 4, $a, Ga);
      m = u * s, h = Ya * u, d = h - (h - u), p = u - d, h = Ya * s, g = h - (h - s), y = s - g, x = p * y - (m - d * g - p * g - d * y), w = c * f, h = Ya * c, d = h - (h - c), p = c - d, h = Ya * f, g = h - (h - f), y = f - g, M = p * y - (w - d * g - p * g - d * y), v = x - M, l = x - v, $a[0] = x - (v + l) + (l - M), _ = m + v, l = _ - m, b = m - (_ - l) + (v - l), v = b - w, l = b - v, $a[1] = b - (v + l) + (l - w), A = _ + v, l = A - _, $a[2] = _ - (A - l) + (v - l), $a[3] = A;
      var D = La(z, Ga, 4, $a, Va);
      return Va[D - 1];
    }(t, n, e, r, i, o, f);
  }

  var Za = Math.pow(2, -52),
    ...
    _createClass(Qa, [{
      ...
      value: function update() {
        ...
        for (var _n27 = 0; _n27 < o; _n27++) {
          var _e14 = Ja(s, l, t[2 * _n27], t[2 * _n27 + 1]);
        ...
        for (var _n28 = 0; _n28 < o; _n28++) {
          ...
          var _e15 = Ja(y, v, t[2 * _n28], t[2 * _n28 + 1]);
        ...
        for (var _n29 = 0; _n29 < o; _n29++) {
          ...
          var _e16 = nu(y, v, _, b, t[2 * _n29], t[2 * _n29 + 1]);
        ...
        if (m === 1 / 0) {
          ...
          for (var _t13 = 0, _r21 = -1 / 0; _t13 < o; _t13++) {
            var _i9 = this._ids[_t13];
        ...
        if (Wa(y, v, _, b, x, w) < 0) {
          var _t14 = d,
              _n32 = _,
              _e18 = b;
          d = p, _ = x, b = w, p = _t14, x = _n32, w = _e18;
        }
        ...
        for (var _n33 = 0; _n33 < o; _n33++) {
          this._dists[_n33] = Ja(t[2 * _n33], t[2 * _n33 + 1], M.x, M.y);
        }

        eu(this._ids, this._dists, 0, o - 1), this._hullStart = h;
        var A = 3;
        ...
        for (var _o10, _a6, _u5 = 0; _u5 < this._ids.length; _u5++) {
          var _c3 = this._ids[_u5],
              _f3 = t[2 * _c3],
              _s2 = t[2 * _c3 + 1];
          if (_u5 > 0 && Math.abs(_f3 - _o10) <= Za && Math.abs(_s2 - _a6) <= Za) continue;
          if (_o10 = _f3, _a6 = _s2, _c3 === h || _c3 === d || _c3 === p) continue;
          var _l2 = 0;

          for (var _t15 = 0, _n34 = this._hashKey(_f3, _s2); _t15 < this._hashSize && (_l2 = i[(_n34 + _t15) % this._hashSize], -1 === _l2 || _l2 === e[_l2]); _t15++) {
            ;
          }
          ...
          for (; _g2 = e[_y2], Wa(_f3, _s2, t[2 * _y2], t[2 * _y2 + 1], t[2 * _g2], t[2 * _g2 + 1]) >= 0;) {
            if (_y2 = _g2, _y2 === _l2) {
              _y2 = -1;
              break;
            }
          ...
          for (; _g2 = e[_2], Wa(_f3, _s2, t[2 * _2], t[2 * _2 + 1], t[2 * _g2], t[2 * _g2 + 1]) < 0;) {
            _v2 = this._addTriangle(_2, _c3, _g2, r[_c3], -1, r[_2]), r[_c3] = this._legalize(_v2 + 2), e[_2] = _2, A--, _2 = _g2;
          }

          if (_y2 === _l2) for (; _g2 = n[_y2], Wa(_f3, _s2, t[2 * _g2], t[2 * _g2 + 1], t[2 * _y2], t[2 * _y2 + 1]) < 0;) {
        ...
        for (var _t16 = 0, _n35 = this._hullStart; _t16 < A; _t16++) {
          this.hull[_t16] = _n35, _n35 = e[_n35];
        }
      ...
      value: function _legalize(t) {
        ...
        for (;;) {
          ...
          if (tu(r[2 * _l3], r[2 * _l3 + 1], r[2 * _h2], r[2 * _h2 + 1], r[2 * _d2], r[2 * _d2 + 1], r[2 * _p2], r[2 * _p2 + 1])) {
            n[t] = _p2, n[_a7] = _l3;
            var _r22 = e[_s3];
      ...
      value: function from(t) {
        var n = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : iu;
        var e = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : ou;
        var r = t.length,
            i = new Float64Array(2 * r);

        for (var _o11 = 0; _o11 < r; _o11++) {
          var _r23 = t[_o11];
          i[2 * _o11] = n(_r23), i[2 * _o11 + 1] = e(_r23);
        }
  ...
  function eu(t, n, e, r) {
    if (r - e <= 20) for (var _i10 = e + 1; _i10 <= r; _i10++) {
      ...
      ru(t, e + r >> 1, _i11), n[t[e]] > n[t[r]] && ru(t, e, r), n[t[_i11]] > n[t[r]] && ru(t, _i11, r), n[t[e]] > n[t[_i11]] && ru(t, e, _i11);
      var _a9 = t[_i11],
          _u8 = n[_a9];
      ...
      t[e + 1] = t[_o13], t[_o13] = _a9, r - _i11 + 1 >= _o13 - e ? (eu(t, n, _i11, r), eu(t, n, e, _o13 - 1)) : (eu(t, n, e, _o13 - 1), eu(t, n, _i11, r));
    }
  }
  ...
  var uu = /*#__PURE__*/function () {
    ...
    _createClass(uu, [{
      ...
      value: function arc(t, n, e) {
        ...
        null === this._x1 ? this._ += "M".concat(r, ",").concat(i) : (Math.abs(this._x1 - r) > au || Math.abs(this._y1 - i) > au) && (this._ += "L" + r + "," + i), e && (this._ += "A".concat(e, ",").concat(e, ",0,1,1,").concat(t - e, ",").concat(n, "A").concat(e, ",").concat(e, ",0,1,1,").concat(this._x1 = r, ",").concat(this._y1 = i));
      }
    }, {
      key: "rect",
  ...
  var fu = /*#__PURE__*/function () {
    ...
    _createClass(fu, [{
      ...
      value: function _init() {
        ...
        for (var _n37, _r25, _o14 = 0, _a10 = 0, _u9 = e.length; _o14 < _u9; _o14 += 3, _a10 += 2) {
          var _u10 = 2 * e[_o14],
              _c5 = 2 * e[_o14 + 1],
              _f5 = 2 * e[_o14 + 2],
              _s4 = t[_u10],
          ...
          if (Math.abs(_m2) < 1e-9) {
            ...
            _i12 *= Math.sign((t[_o15] - _s4) * _b2 - (t[_o15 + 1] - _l4) * _3), _n37 = (_s4 + _p3) / 2 - _i12 * _b2, _r25 = (_l4 + _g3) / 2 + _i12 * _3;
          } else {
            var _t17 = 1 / _m2,
                _e19 = _y3 * _y3 + _v3 * _v3,
                _i13 = _3 * _3 + _b2 * _b2;

            _n37 = _s4 + (_b2 * _e19 - _v3 * _i13) * _t17, _r25 = _l4 + (_y3 * _i13 - _3 * _e19) * _t17;
          }
      ...
      value: function renderCell(t, n) {
        ...
        for (var _t18 = 2; _t18 < i; _t18 += 2) {
          r[_t18] === r[_t18 - 2] && r[_t18 + 1] === r[_t18 - 1] || n.lineTo(r[_t18], r[_t18 + 1]);
        }
      ...
      value: /*#__PURE__*/regeneratorRuntime.mark(function neighbors(t) {
        var n, _iterator32, _step32, _e23, _t20, _r28, _i15, _o16, _a12;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 12:
                ...
                if (!(n[_r28] == _t20[_o16] && n[_r28 + 1] == _t20[_o16 + 1] && n[(_r28 + 2) % _i15] == _t20[(_o16 + _a12 - 2) % _a12] && n[(_r28 + 3) % _i15] == _t20[(_o16 + _a12 - 1) % _a12])) {
                  _context5.next = 17;
                  break;
                }
      ...
      value: function _edge(t, n, e, r, i) {
        for (; n !== e;) {
          ...
          switch (n) {
            ...
            case 4:
              n = 6, _e27 = this.xmax, _o17 = this.ymin;
              break;
            ...
            case 2:
              n = 10, _e27 = this.xmax, _o17 = this.ymax;
              break;
            ...
            case 8:
              n = 9, _e27 = this.xmin, _o17 = this.ymax;
              break;
            ...
            case 1:
              n = 5, _e27 = this.xmin, _o17 = this.ymin;
          }

          r[i] === _e27 && r[i + 1] === _o17 || !this.contains(t, _e27, _o17) || (r.splice(i, 0, _e27, _o17), i += 2);
        }

        if (r.length > 4) for (var _t21 = 0; _t21 < r.length; _t21 += 2) {
          var _n47 = (_t21 + 2) % r.length,
              _e28 = (_t21 + 4) % r.length;

          (r[_t21] === r[_n47] && r[_n47] === r[_e28] || r[_t21 + 1] === r[_n47 + 1] && r[_n47 + 1] === r[_e28 + 1]) && (r.splice(_n47, 2), _t21 -= 2);
        }
        return i;
      }
    }, {
  ...
  var gu = /*#__PURE__*/function () {
    function gu(t) {
      ...
      this._delaunator = new Qa(t), this.inedges = new Int32Array(t.length / 2), this._hullIndex = new Int32Array(t.length / 2), this.points = this._delaunator.coords, this._init();
    }
    ...
    _createClass(gu, [{
      ...
      value: function _init() {
        ...
        if (t.hull && t.hull.length > 2 && function (t) {
          ...
          for (var _t22 = 0; _t22 < n.length; _t22 += 3) {
            var _r30 = 2 * n[_t22],
                _i17 = 2 * n[_t22 + 1],
                _o18 = 2 * n[_t22 + 2];

            if ((e[_o18] - e[_r30]) * (e[_i17 + 1] - e[_r30 + 1]) - (e[_i17] - e[_r30]) * (e[_o18 + 1] - e[_r30 + 1]) > 1e-10) return !1;
          }
          ...
          var _t23 = this.collinear[0],
              _e29 = this.collinear[this.collinear.length - 1],
              _r31 = [n[2 * _t23], n[2 * _t23 + 1], n[2 * _e29], n[2 * _e29 + 1]],
              _i18 = 1e-8 * Math.hypot(_r31[3] - _r31[1], _r31[2] - _r31[0]);

          for (var _t24 = 0, _e30 = n.length / 2; _t24 < _e30; ++_t24) {
            var _e31 = pu(n[2 * _t24], n[2 * _t24 + 1], _i18);

            n[2 * _t24] = _e31[0], n[2 * _t24 + 1] = _e31[1];
          }
        ...
        for (var _t25 = 0, _n48 = e.length; _t25 < _n48; ++_t25) {
          var _n49 = i[_t25 % 3 == 2 ? _t25 - 2 : _t25 + 1];
          -1 !== e[_t25] && -1 !== o[_n49] || (o[_n49] = _t25);
        }

        for (var _t26 = 0, _n50 = r.length; _t26 < _n50; ++_t26) {
          a[r[_t26]] = _t26;
        }
      ...
      value: function _step(t, n, e) {
        ...
        do {
          ...
          var _l6 = lu(n - c[2 * _r32], 2) + lu(e - c[2 * _r32 + 1], 2);

          if (_l6 < s && (s = _l6, f = _r32), h = h % 3 == 2 ? h - 2 : h + 1, u[h] !== t) break;

          if (h = a[h], -1 === h) {
            if (h = i[(o[t] + 1) % i.length], h !== _r32 && lu(n - c[2 * h], 2) + lu(e - c[2 * h + 1], 2) < s) return h;
            break;
          }
        } while (h !== l);
      ...
      value: function render(t) {
        ...
        for (var _n53 = 0, _o19 = r.length; _n53 < _o19; ++_n53) {
          var _o20 = r[_n53];
          if (_o20 < _n53) continue;
      ...
      value: function renderPoints(t, n) {
        ...
        var e = null == t ? t = new uu() : void 0,
            r = this.points;

        for (var _e32 = 0, _i19 = r.length; _e32 < _i19; _e32 += 2) {
          var _i20 = r[_e32],
              _o21 = r[_e32 + 1];
          t.moveTo(_i20 + n, _o21), t.arc(_i20, _o21, n, 0, su);
        }
      ...
      key: "from",
      value: function from(t) {
        var n = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : hu;
        var e = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : du;
        ...
        return new gu("length" in t ? function (t, n, e, r) {
          ...
          var i, _iterator33, _step33, _o22;
            ...
            while (1) {
              switch (_context8.prev = _context8.next) {
                ...
                case 4:
                  ...
                  _o22 = _step33.value;
                  _context8.next = 8;
                  return n.call(r, _o22, i, t);

                case 8:
                  _context8.next = 10;
                  return e.call(r, _o22, i, t);
  ...
  function wu(t) {
    ...
    function r(t, n) {
      ...
      for (10 === t.charCodeAt(o - 1) && --o, 13 === t.charCodeAt(o - 1) && --o; (r = s()) !== vu;) {
        for (var l = []; r !== yu && r !== vu;) {
          l.push(r), r = s();
        }
    ...
    return {
      ...
      format: function format(n, e) {
        return null == e && (e = bu(n)), [e.map(a).join(t)].concat(i(n, e)).join("\n");
      },
      formatBody: function formatBody(t, n) {
        return null == n && (n = bu(t)), i(t, n).join("\n");
      },
  ...
  var Mu = wu(","),
      ...
      Ou = Pu.formatRow,
      Uu = Pu.formatValue;
  var Iu = new Date("2019-01-01T00:00").getHours() || new Date("2019-07-01T00:00").getHours();
  ...
  function Hu(t) {
    return function (n, e, r) {
      return 2 === arguments.length && "function" == typeof e && (r = e, e = void 0), ju(n, e).then(function (n) {
        return t(n, r);
      });
    };
  }
  ...
  oc.copy = function () {
    var t,
        n,
        e = new rc(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
        r = this._root;
    if (!r) return e;
    if (!r.length) return e._root = ic(r), e;
    ...
    for (g && p.push(new Ju(g, s, l, h, d)), null == e ? e = 1 / 0 : (s = t - e, l = n - e, h = t + e, d = n + e, e *= e); c = p.pop();) {
      if (!(!(g = c.node) || (i = c.x0) > h || (o = c.y0) > d || (a = c.x1) < s || (u = c.y1) < l)) if (g.length) {
        var y = (i + a) / 2,
            v = (o + u) / 2;
        p.push(new Ju(g[3], y, v, a, u), new Ju(g[2], i, v, y, u), new Ju(g[1], y, o, a, v), new Ju(g[0], i, o, y, v)), (f = (n >= v) << 1 | t >= y) && (c = p[p.length - 1], p[p.length - 1] = p[p.length - 1 - f], p[p.length - 1 - f] = c);
      } else {
    ...
    for (c && u.push(new Ju(c, this._x0, this._y0, this._x1, this._y1)); n = u.pop();) {
      if (!t(c = n.node, r = n.x0, i = n.y0, o = n.x1, a = n.y1) && c.length) {
        var f = (r + o) / 2,
            s = (i + a) / 2;
        (e = c[3]) && u.push(new Ju(e, f, s, o, a)), (e = c[2]) && u.push(new Ju(e, r, s, f, a)), (e = c[1]) && u.push(new Ju(e, f, i, o, s)), (e = c[0]) && u.push(new Ju(e, r, i, f, s));
      }
    }
    ...
    for (this._root && e.push(new Ju(this._root, this._x0, this._y0, this._x1, this._y1)); n = e.pop();) {
      ...
      if (i.length) {
        var o,
            ...
            s = (a + c) / 2,
            l = (u + f) / 2;
        (o = i[0]) && e.push(new Ju(o, a, u, s, l)), (o = i[1]) && e.push(new Ju(o, s, u, c, l)), (o = i[2]) && e.push(new Ju(o, a, l, s, f)), (o = i[3]) && e.push(new Ju(o, s, l, c, f));
      }
  ...
  function mc(t) {
    if (!(n = bc.exec(t))) throw new Error("invalid format: " + t);
    var n;
    return new xc({
      fill: n[1],
      align: n[2],
  ...
  mc.prototype = xc.prototype, xc.prototype.toString = function () {
  ...
  var Tc,
      Sc = Array.prototype.map,
      Ec = ["y", "z", "a", "f", "p", "n", "µ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y"];

  function kc(t) {
    var n,
        e,
        r = void 0 === t.grouping || void 0 === t.thousands ? Ac : (n = Sc.call(t.grouping, Number), e = t.thousands + "", function (t, r) {
      ...
      return o.reverse().join(e);
        ...
        u = void 0 === t.numerals ? Ac : function (t) {
      return function (n) {
        return n.replace(/[0-9]/g, function (n) {
          return t[+n];
        });
      };
    }(Sc.call(t.numerals, String)),
    ...
    function l(t) {
      var n = (t = mc(t)).fill,
          ...
          v = t.trim,
          _ = t.type;
      "n" === _ ? (g = !0, _ = "g") : Mc[_] || (void 0 === y && (y = 12), v = !0, _ = "g"), (d || "0" === n && "=" === e) && (d = !0, n = "0", e = "=");
      ...
      function M(t) {
        ...
        if ("c" === _) M = x(t) + M, t = "";else {
          ...
          }(t)), A && 0 == +t && "+" !== l && (A = !1), h = (A ? "(" === l ? l : f : "-" === l || "(" === l ? "" : l) + h, M = ("s" === _ ? Ec[8 + _c / 3] : "") + M + (A && "(" === l ? ")" : ""), w) for (i = -1, o = t.length; ++i < o;) {
  ...
  function Nc(n) {
    return Tc = kc(n), t.format = Tc.format, t.formatPrefix = Tc.formatPrefix, Tc;
  }
  ...
  function zc(t, n) {
    return t = Math.abs(t), n = Math.abs(n) - t, Math.max(0, vc(n) - vc(t)) + 1;
  }

  t.format = void 0, t.formatPrefix = void 0, Nc({
    thousands: ",",
    grouping: [3],
    currency: ["$", ""]
  });
  ...
  function nf(t) {
    return t > 1 ? Fc : t < -1 ? -Fc : Math.asin(t);
  }
  ...
  var lf,
    ...
    polygonStart: function polygonStart() {
      Ef = new y(), Nf.lineStart = Cf, Nf.lineEnd = Pf;
    },
    polygonEnd: function polygonEnd() {
      var t = +Ef;
      kf.add(t < 0 ? Uc + t : t), this.lineStart = this.lineEnd = this.point = rf;
    },
  ...
  function zf(t, n) {
    Nf.point = Df, lf = t, hf = n, df = t *= Bc, pf = Hc(n = (n *= Bc) / 2 + Oc), gf = Zc(n);
  }
  ...
  var Yf,
    ...
    lineEnd: us,
    polygonStart: function polygonStart() {
      rs.point = cs, rs.lineStart = fs, rs.lineEnd = ss, Af = new y(), Nf.polygonStart();
    },
    polygonEnd: function polygonEnd() {
      Nf.polygonEnd(), rs.point = is, rs.lineStart = as, rs.lineEnd = us, Ef < 0 ? (yf = -(_f = 180), vf = -(bf = 90)) : Af > Dc ? bf = 90 : Af < -1e-6 && (vf = -90), Sf[0] = yf, Sf[1] = _f;
    },
    sphere: function sphere() {
      yf = -(_f = 180), vf = -(bf = 90);
    }
  ...
  function is(t, n) {
    Tf.push(Sf = [yf = t, _f = t]), n < vf && (vf = n), n > bf && (bf = n);
  }
  ...
  function os(t, n) {
    ...
    if (Mf) {
      ...
      var o,
          ...
          c = i[0] * Ic * u,
          f = Yc(a) > 180;
      f ^ (u * mf < c && c < u * t) ? (o = i[1] * Ic) > bf && (bf = o) : f ^ (u * mf < (c = (c + 360) % 360 - 180) && c < u * t) ? (o = -i[1] * Ic) < vf && (vf = o) : (n < vf && (vf = n), n > bf && (bf = n)), f ? t < mf ? ls(yf, t) > ls(yf, _f) && (_f = t) : ls(t, _f) > ls(yf, _f) && (yf = t) : _f >= yf ? (t < yf && (yf = t), t > _f && (_f = t)) : t > mf ? ls(yf, t) > ls(yf, _f) && (_f = t) : ls(t, _f) > ls(yf, _f) && (yf = t);
    } else Tf.push(Sf = [yf = t, _f = t]);

    n < vf && (vf = n), n > bf && (bf = n), Mf = e, mf = t;
  }
  ...
  function us() {
    Sf[0] = yf, Sf[1] = _f, rs.point = is, Mf = null;
  }
  ...
  function ss() {
    cs(xf, wf), Nf.lineEnd(), Yc(Af) > Dc && (yf = -(_f = 180)), Sf[0] = yf, Sf[1] = _f, Mf = null;
  }
  ...
  var ps = {
    ...
    lineEnd: ms,
    polygonStart: function polygonStart() {
      ps.lineStart = xs, ps.lineEnd = ws;
    },
    polygonEnd: function polygonEnd() {
      ps.lineStart = vs, ps.lineEnd = ms;
    }
  };
  ...
  function ys(t, n, e) {
    ++Yf, jf += (t - jf) / Yf, Hf += (n - Hf) / Yf, Xf += (e - Xf) / Yf;
  }
  ...
  function _s(t, n) {
    t *= Bc;
    var e = Hc(n *= Bc);
    ts = e * Hc(t), ns = e * Zc(t), es = Zc(n), ps.point = bs, ys(ts, ns, es);
  }
  ...
  function bs(t, n) {
    ...
    Lf += a, Gf += a * (ts + (ts = r)), Vf += a * (ns + (ns = i)), $f += a * (es + (es = o)), ys(ts, ns, es);
  }
  ...
  function ws() {
    As(Qf, Jf), ps.point = gs;
  }

  function Ms(t, n) {
    Qf = t, Jf = n, t *= Bc, n *= Bc, ps.point = As;
    var e = Hc(n);
    ts = e * Hc(t), ns = e * Zc(t), es = Zc(n), ys(ts, ns, es);
  }
  ...
  function As(t, n) {
    ...
    var e = Hc(n *= Bc),
        ...
        s = nf(f),
        l = f && -s / f;
    Wf.add(l * a), Zf.add(l * u), Kf.add(l * c), Lf += s, Gf += s * (ts + (ts = r)), Vf += s * (ns + (ns = i)), $f += s * (es + (es = o)), ys(ts, ns, es);
  }
  ...
  function Es(t, n) {
    return [Yc(t) > Rc ? t + Math.round(-t / Uc) * Uc : t, n];
  }
  ...
  function zs(t) {
    function n(n) {
      return (n = t(n[0] * Bc, n[1] * Bc))[0] *= Ic, n[1] *= Ic, n;
    }

    return t = ks(t[0] * Bc, t[1] * Bc, t.length > 2 ? t[2] * Bc : 0), n.invert = function (n) {
      return (n = t.invert(n[0] * Bc, n[1] * Bc))[0] *= Ic, n[1] *= Ic, n;
    }, n;
  }
  ...
  function Ds(t, n, e, r, i, o) {
    if (e) {
      var a = Hc(n),
          u = Zc(n),
          c = r * e;
      null == i ? (i = n + r * Uc, o = n - c / 2) : (i = qs(a, i), o = qs(a, o), (r > 0 ? i < o : i > o) && (i += r * Uc));

      for (var f, s = i; r > 0 ? s > o : s < o; s -= c) {
        f = qf([a, -u * Hc(s), -u * Zc(s)]), t.point(f[0], f[1]);
      }
    }
  }
  ...
  function Us(t, n, e, r, i) {
    ...
    if (t.forEach(function (t) {
      if (!((n = t.length - 1) <= 0)) {
        ...
        u.push(e = new Os(r, t, null, !0)), c.push(e.o = new Os(r, null, e, !1)), u.push(e = new Os(a, t, null, !1)), c.push(e.o = new Os(a, null, e, !0));
      }
    }), u.length) {
      for (c.sort(n), Is(u), Is(c), o = 0, a = c.length; o < a; ++o) {
        c[o].e = e = !e;
      }
  ...
  function Bs(t) {
    return Yc(t[0]) <= Rc ? t[0] : Kc(t[0]) * ((Yc(t[0]) + Rc) % Uc - Rc);
  }
  ...
  function Ys(t, n) {
    var e = Bs(n),
        ...
        u = 0,
        c = new y();
    1 === i ? r = Fc + Dc : -1 === i && (r = -Fc - Dc);

    for (var f = 0, s = t.length; f < s; ++f) {
      if (h = (l = t[f]).length) for (var l, h, d = l[h - 1], p = Bs(d), g = d[1] / 2 + Oc, v = Zc(g), _ = Hc(g), b = 0; b < h; ++b, p = x, v = M, _ = A, d = m) {
        var m = l[b],
            x = Bs(m),
            w = m[1] / 2 + Oc,
            M = Zc(w),
        ...
        if (c.add(jc(N * S * Zc(E), _ * A + N * Hc(E))), a += k ? T + S * Uc : T, k ^ p >= e ^ x >= e) {
          var C = Of(Rf(d), Rf(m));
          Bf(C);
          var P = Of(o, C);
          Bf(P);
  ...
  function Ls(t, n, e, r) {
    return function (i) {
      var o,
        ...
        polygonEnd: function polygonEnd() {
          h.point = d, h.lineStart = g, h.lineEnd = y, a = K(a);
          var t = Ys(o, r);
          a.length ? (l || (i.polygonStart(), l = !0), Us(a, Hs, t, e, i)) : t && (l || (i.polygonStart(), l = !0), i.lineStart(), e(null, null, 1, i), i.lineEnd()), l && (i.polygonEnd(), l = !1), a = o = null;
        },
        sphere: function sphere() {
      ...
      function b() {
        ...
        } else d > 1 && 2 & c && h.push(h.pop().concat(h.shift())), a.push(h.filter(js));
      }
  ...
  function Hs(t, n) {
    return ((t = t.x)[0] < 0 ? t[1] - Fc - Dc : Fc - t[1]) - ((n = n.x)[0] < 0 ? n[1] - Fc - Dc : Fc - n[1]);
  }
  ...
  var Xs = Ls(function () {
    ...
    return {
      ...
      point: function point(o, a) {
        var u = o > 0 ? Rc : -Rc,
            c = Yc(o - e);
        Yc(c - Rc) < Dc ? (t.point(e, r = (r + a) / 2 > 0 ? Fc : -Fc), t.point(i, r), t.lineEnd(), t.lineStart(), t.point(u, r), t.point(o, r), n = 0) : i !== u && c >= Rc && (Yc(e - i) < Dc && (e -= i * Dc), Yc(o - u) < Dc && (o -= u * Dc), r = function (t, n, e, r) {
          var i,
              o,
              a = Zc(t - e);
    ...
    var i;
    if (null == t) i = e * Fc, r.point(-Rc, i), r.point(0, i), r.point(Rc, i), r.point(Rc, 0), r.point(Rc, -i), r.point(0, -i), r.point(-Rc, -i), r.point(-Rc, 0), r.point(-Rc, i);else if (Yc(t[0] - n[0]) > Dc) {
      var o = t[0] < n[0] ? Rc : -Rc;
  ...
  function Gs(t) {
    ...
    function a(t, e, r) {
      ...
      if (!(y < 0)) {
        ...
        if (!T && M < w && (b = w, w = M, M = b), T || A < Dc ? T ? w + M > 0 ^ _[1] < (Yc(_[0] - m) < Dc ? w : M) : w <= _[1] && _[1] <= M : A > Rc ^ (m <= _[0] && _[0] <= x)) {
          var S = If(d, (-p + v) / g);
          return Uf(S, h), [_, qf(S)];
        }
      }
    }
      ...
      return {
        ...
        point: function point(l, h) {
          var d,
              p = [l, h],
              g = o(l, h),
              y = r ? g ? 0 : u(l, h) : g ? u(l + (l < 0 ? Rc : -Rc), h) : 0;
          if (!n && (f = c = g) && t.lineStart(), g !== c && (!(d = a(n, p)) || Fs(n, d) || Fs(p, d)) && (p[2] = 1), g !== c) s = 0, g ? (t.lineStart(), d = a(p, n), t.point(d[0], d[1])) : (d = a(n, p), t.point(d[0], d[1], 2), t.lineEnd()), n = d;else if (i && n && r ^ g) {
            var v;
          ...
          !g || n && Fs(n, p) || t.point(p[0], p[1]), n = p, c = g, e = y;
        },
        lineEnd: function lineEnd() {
          c && t.lineEnd(), n = null;
        },
  ...
  function el(t, n) {
    $s = t *= Bc, Ws = Zc(n *= Bc), Zs = Hc(n), tl.point = rl;
  }
  ...
  function rl(t, n) {
    ...
    var e = Zc(n *= Bc),
        ...
        u = Zs * e - Ws * r * o,
        c = Ws * e + Zs * r * o;
    Vs.add(jc(Qc(a * a + u * u), c)), $s = t, Ws = e, Zs = r;
  }

  function il(t) {
    return Vs = new y(), sf(t, tl), +Vs;
  }
  ...
  function _l() {
    ...
    return v.lines = function () {
      ...
      return arguments.length ? (y = +h, c = yl(o, i, 90), f = vl(n, t, y), s = yl(u, a, 90), l = vl(r, e, y), v) : y;
  ...
  var bl,
    ...
    lineEnd: rf,
    polygonStart: function polygonStart() {
      Sl.lineStart = El, Sl.lineEnd = Cl;
    },
    polygonEnd: function polygonEnd() {
      Sl.lineStart = Sl.lineEnd = Sl.point = rf, Al.add(Yc(Tl)), Tl = new y();
    },
    result: function result() {
      var t = Al / 2;
      return Al = new y(), t;
  ...
  function kl(t, n) {
    Sl.point = Nl, bl = xl = t, ml = wl = n;
  }

  function Nl(t, n) {
    Tl.add(wl * t - xl * n), xl = t, wl = n;
  }
  ...
  function nh(t, n) {
    var e = t - Il,
        r = n - Bl,
        i = Qc(e * e + r * r);
    Xl += i * (Il + t) / 2, Gl += i * (Bl + n) / 2, Vl += i, Ql(Il = t, Bl = n);
  }
  ...
  function oh(t, n) {
    Kl.point = ah, Ql(Ol = Il = t, Ul = Bl = n);
  }
  ...
  function ah(t, n) {
    var e = t - Il,
        r = n - Bl,
        i = Qc(e * e + r * r);
    Xl += i * (Il + t) / 2, Gl += i * (Bl + n) / 2, Vl += i, $l += (i = Bl * t - Il * n) * (Il + t), Wl += i * (Bl + n), Zl += 3 * i, Ql(Il = t, Bl = n);
  }
  ...
  function vh(t, n) {
    hh -= t, dh -= n, ph.add(Qc(hh * hh + dh * dh)), hh = t, dh = n;
  }
  ...
  function Mh(t, n, e) {
    ...
    return t.scale(150).translate([0, 0]), null != r && t.clipExtent(null), sf(e, t.stream(Yl)), n(Yl.result()), null != r && t.clipExtent(r), t;
  }
      ...
      function e(r, i, o, a, u, c, f, s, l, h, d, p, g, y) {
        ...
        if (b > 4 * n && g--) {
          var m = a + h,
              ...
              C = k - i,
              P = _ * N - v * C;
          (P * P / b > n || Yc((v * N + _ * C) / b - .5) > .3 || a * h + u * d + c * p < kh) && (e(r, i, o, a, u, c, E, k, T, m /= M, x /= M, w, g, y), y.point(E, k), e(E, k, T, m, x, w, f, s, l, h, d, p, g, y));
        }
      }
  ...
  function Dh(t) {
    ...
    function N() {
      ...
      return e = ks(y, v, _), u = Ss(n, r), c = Ss(e, u), a = Nh(u, S), C();
    }
    ...
    return E.stream = function (t) {
      ...
      return arguments.length ? (M = +t ? Gs(w = t * Bc) : (w = null, Xs), C()) : w * Ic;
    }, E.clipExtent = function (t) {
      return arguments.length ? (T = null == t ? (A = r = i = o = null, Ml) : Js(A = +t[0][0], r = +t[0][1], i = +t[1][0], o = +t[1][1]), C()) : null == A ? null : [[A, r], [i, o]];
    }, E.scale = function (t) {
      return arguments.length ? (l = +t, N()) : l;
    }, E.translate = function (t) {
      return arguments.length ? (h = +t[0], d = +t[1], N()) : [h, d];
    }, E.center = function (t) {
      return arguments.length ? (p = t[0] % 360 * Bc, g = t[1] % 360 * Bc, N()) : [p * Ic, g * Ic];
    }, E.rotate = function (t) {
      return arguments.length ? (y = t[0] % 360 * Bc, v = t[1] % 360 * Bc, _ = t.length > 2 ? t[2] % 360 * Bc : 0, N()) : [y * Ic, v * Ic, _ * Ic];
    }, E.angle = function (t) {
      return arguments.length ? (b = t % 360 * Bc, N()) : b * Ic;
    }, E.reflectX = function (t) {
      return arguments.length ? (m = t ? -1 : 1, N()) : m < 0;
    }, E.reflectY = function (t) {
      return arguments.length ? (x = t ? -1 : 1, N()) : x < 0;
    }, E.precision = function (t) {
      return arguments.length ? (a = Nh(u, S = t * t), C()) : Qc(S);
  ...
  function Rh(t, n) {
    ...
    return a.invert = function (t, n) {
      var e = o - n,
          a = jc(t, Yc(e)) * Kc(e);
      return e * r < 0 && (a -= Rc * Kc(t) * Kc(e)), [a / r, nf((i - (t * t + e * e) * r * r) / (2 * r))];
    }, a;
  }
  ...
  function Xh(t, n) {
    ...
    function o(t, n) {
      i > 0 ? n < -Fc + Dc && (n = -Fc + Dc) : n > Fc - Dc && (n = Fc - Dc);
      var e = i / Wc(Hh(n), r);
    ...
    return o.invert = function (t, n) {
      var e = i - n,
          o = Kc(r) * Qc(t * t + e * e),
          a = jc(t, Yc(e)) * Kc(e);
      return e * r < 0 && (a -= Rc * Kc(t) * Kc(e)), [a / r, 2 * Lc(Wc(i / o, 1 / r)) - Fc];
    }, o;
  }
  ...
  function Vh(t, n) {
    ...
    return o.invert = function (t, n) {
      var e = i - n,
          o = jc(t, Yc(e)) * Kc(e);
      return e * r < 0 && (o -= Rc * Kc(t) * Kc(e)), [o / r, i - Kc(r) * Qc(t * t + e * e)];
    }, o;
  }
  ...
  Jh.invert = function (t, n) {
    for (var e, r = n, i = r * r, o = i * i * i, a = 0; a < 12 && (o = (i = (r -= e = (r * ($h + Wh * i + o * (Zh + Kh * i)) - n) / ($h + 3 * Wh * i + o * (7 * Zh + 9 * Kh * i))) * r) * i * i, !(Yc(e) < qc)); ++a) {
      ;
    }

    return [Qh * t * ($h + 3 * Wh * i + o * (7 * Zh + 9 * Kh * i)) / Hc(r), nf(Zc(r) / Qh)];
  }, td.invert = Ih(Lc), nd.invert = function (t, n) {
    var e,
        r = n,
        i = 25;
  ...
  }, ed.invert = Ih(nf), rd.invert = Ih(function (t) {
    return 2 * Lc(t);
  }), id.invert = function (t, n) {
    return [-n, 2 * Lc(Gc(t)) - Fc];
  ...
  function Jd(t, n, e, r, i, o) {
    for (var a, u, c, f, s, l, h, d, p, g, y, v = [], _ = n.children, b = 0, m = 0, x = _.length, w = n.value; b < x;) {
      ...
      }), a.dice ? Od(a, e, r, i, w ? r += f * s / w : o) : Kd(a, e, r, w ? e += c * s / w : i, o), w -= s, b = m;
    }
  ...
  var np = function t(n) {
    function e(t, e, r, i, o) {
      if ((a = t._squarify) && a.ratio === n) for (var a, u, c, f, s, l = -1, h = a.length, d = t.value; ++l < h;) {
        ...
        u.dice ? Od(u, e, r, i, d ? r += (o - r) * u.value / d : o) : Kd(u, e, r, d ? e += (i - e) * u.value / d : i, o), d -= u.value;
      } else t._squarify = a = Jd(n, t, e, r, i, o), a.ratio = n;
    }
  ...
  function kp() {
    ...
    return delete e.unknown, e.domain = function (t) {
      ...
      return arguments.length ? ((_t27 = t, _t28 = _slicedToArray(_t27, 2), o = _t28[0], a = _t28[1], _t27), o = +o, a = +a, l()) : [o, a];
    }, e.rangeRound = function (t) {
      var _t29, _t30;

      return (_t29 = t, _t30 = _slicedToArray(_t29, 2), o = _t30[0], a = _t30[1], _t29), o = +o, a = +a, u = !0, l();
  ...
  function qp(t, n, e) {
    var r = t[0],
        ...
        o = n[0],
        a = n[1];
    return i < r ? (r = Dp(i, r), o = e(a, o)) : (r = Dp(r, i), o = e(o, a)), function (t) {
      return o(r(t));
    };
  }
  ...
  function Rp(t, n, e) {
    ...
    for (t[r] < t[0] && (t = t.slice().reverse(), n = n.slice().reverse()); ++a < r;) {
      i[a] = Dp(t[a], t[a + 1]), o[a] = e(n[a], n[a + 1]);
    }
  ...
  function Op() {
    ...
    function s() {
      ...
      }(a[0], a[t - 1])), r = t > 2 ? Rp : qp, i = o = null, l;
    }
    ...
    return l.invert = function (e) {
      ...
      return arguments.length ? (a = Array.from(t, Cp), s()) : a.slice();
    }, l.range = function (t) {
      return arguments.length ? (u = Array.from(t), s()) : u.slice();
    }, l.rangeRound = function (t) {
      return u = Array.from(t), c = Pr, s();
    }, l.clamp = function (t) {
      return arguments.length ? (f = !!t || zp, s()) : f !== zp;
  ...
  function Ip(n, e, r, i) {
    ...
    switch ((i = mc(null == i ? ",f" : i)).type) {
      case "s":
        ...
        return null != i.precision || isNaN(o = Pc(a, u)) || (i.precision = o), t.formatPrefix(i, u);
  ...
  function $p(n) {
    ...
    function u() {
      return i = function (t) {
        ...
        return 10 === t ? Gp : t === Math.E ? Math.exp : function (n) {
          return Math.pow(t, n);
        };
      }(a), r()[0] < 0 ? (i = Vp(i), o = Vp(o), n(Hp, Xp)) : n(Lp, jp), e;
    }
    ...
    return e.base = function (t) {
      ...
      var e = n[0],
          u = n[n.length - 1];
      var c = u < e;
      c && (_ref10 = [u, e], e = _ref10[0], u = _ref10[1], _ref10);
      var f,
          s,
          l = i(e),
          h = i(u);
      ...
      } else p = U(l, h, Math.min(h - l, d)).map(o);

      return c ? p.reverse() : p;
    }, e.tickFormat = function (n, r) {
      if (null == n && (n = 10), null == r && (r = 10 === a ? "s" : ","), "function" != typeof r && (a % 1 || null != (r = mc(r)).precision || (r.trim = !0), r = t.format(r)), n === 1 / 0) return r;
      var u = Math.max(1, a * n / e.ticks().length);
      return function (t) {
  ...
  function ug(t, n, e, r) {
    ...
    return i.floor = function (n) {
      ...
      return og.setTime(+n), ag.setTime(+r), t(og), t(ag), Math.floor(e(og, ag));
    }, i.every = function (t) {
  ...
  var cg = ug(function () {}, function (t, n) {
    t.setTime(+t + n);
  }, function (t, n) {
    return n - t;
  });
  ...
  cg.every = function (t) {
    return t = Math.floor(t), isFinite(t) && t > 0 ? t > 1 ? ug(function (n) {
  ...
  var _g = ug(function (t) {
    ...
    return (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * hg) / pg;
  }, function (t) {
    return t.getDate() - 1;
  }),
      kg = Eg,
  ...
  function Ey(t, n, r, i, o, a) {
    var u = [[bg, 1, lg], [bg, 5, 5e3], [bg, 15, 15e3], [bg, 30, 3e4], [a, 1, hg], [a, 5, 3e5], [a, 15, 9e5], [a, 30, 18e5], [o, 1, dg], [o, 3, 108e5], [o, 6, 216e5], [o, 12, 432e5], [i, 1, pg], [i, 2, 1728e5], [r, 1, gg], [n, 1, yg], [n, 3, 7776e6], [t, 1, vg]];
    ...
    function c(n, r, i) {
      ...
      if (a === u.length) return t.every(B(n / vg, r / vg, i));
      if (0 === a) return fg.every(Math.max(B(n, r, i), 1));
    ...
    return [function (t, n, e) {
      ...
      var r = n < t;
      r && (_ref13 = [n, t], t = _ref13[0], n = _ref13[1], _ref13);
  ...
  var _Ey = Ey(Ty, wy, uy, iy, ny, Qg),
      _Ey2 = _slicedToArray(_Ey, 2),
      ky = _Ey2[0],
      Ny = _Ey2[1],
      _Ey3 = Ey(Wg, Gg, Pg, kg, Tg, wg),
      _Ey4 = _slicedToArray(_Ey3, 2),
      Cy = _Ey4[0],
      Py = _Ey4[1];
    ...
    function w(t, n) {
      return function (e) {
        ...
        for (e instanceof Date || (e = new Date(+e)); ++u < f;) {
          37 === t.charCodeAt(u) && (a.push(t.slice(c, u)), null != (i = Oy[r = t.charAt(++u)]) ? r = t.charAt(++u) : i = "e" === r ? " " : "0", (o = n[r]) && (r = o(e, i)), a.push(r), c = u + 1);
        }
    ...
    function M(t, n) {
      return function (e) {
        ...
        if (n && !("Z" in o) && (o.Z = 0), "p" in o && (o.H = o.H % 12 + 12 * o.p), void 0 === o.m && (o.m = "q" in o ? o.q : 0), "V" in o) {
          ...
          "w" in o || (o.w = 1), "Z" in o ? (i = (r = Dy(qy(o.y, 0, 1))).getUTCDay(), r = i > 4 || 0 === i ? cy.ceil(r) : cy(r), r = iy.offset(r, 7 * (o.V - 1)), o.y = r.getUTCFullYear(), o.m = r.getUTCMonth(), o.d = r.getUTCDate() + (o.w + 6) % 7) : (i = (r = zy(qy(o.y, 0, 1))).getDay(), r = i > 4 || 0 === i ? zg.ceil(r) : zg(r), r = kg.offset(r, 7 * (o.V - 1)), o.y = r.getFullYear(), o.m = r.getMonth(), o.d = r.getDate() + (o.w + 6) % 7);
        } else ("W" in o || "U" in o) && ("w" in o || (o.w = "u" in o ? o.u % 7 : "W" in o ? 1 : 0), i = "Z" in o ? Dy(qy(o.y, 0, 1)).getUTCDay() : zy(qy(o.y, 0, 1)).getDay(), o.m = 0, o.d = "W" in o ? (o.w + 6) % 7 + 7 * o.W - (i + 5) % 7 : o.w + 7 * o.U - (i + 6) % 7);

        return "Z" in o ? (o.H += o.Z / 100 | 0, o.M += o.Z % 100, Dy(o)) : zy(o);
      };
    }
    ...
    function A(t, n, e, r) {
      for (var i, o, a = 0, u = n.length, c = e.length; a < u;) {
        ...
        if (37 === (i = n.charCodeAt(a++))) {
          if (i = n.charAt(a++), !(o = x[i in Oy ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0) return -1;
  ...
  function wv(t) {
    var n = t.getDay();
    return n >= 4 || 0 === n ? Rg(t) : Rg.ceil(t);
  }

  function Mv(t, n) {
    return t = wv(t), Yy(Rg.count(Wg(t), t) + (4 === Wg(t).getDay()), n, 2);
  }
  ...
  function Nv(t, n) {
    var e = t.getDay();
    return Yy((t = e >= 4 || 0 === e ? Rg(t) : Rg.ceil(t)).getFullYear() % 1e4, n, 4);
  }

  function Cv(t) {
    var n = t.getTimezoneOffset();
    return (n > 0 ? "-" : (n *= -1, "+")) + Yy(n / 60 | 0, "0", 2) + Yy(n % 60, "0", 2);
  }
  ...
  function jv(t, n) {
    return t = Lv(t), Yy(ly.count(Ty(t), t) + (4 === Ty(t).getUTCDay()), n, 2);
  }
  ...
  function t_(n) {
    return Fy = Ry(n), t.timeFormat = Fy.format, t.timeParse = Fy.parse, t.utcFormat = Fy.utcFormat, t.utcParse = Fy.utcParse, Fy;
  }

  t.timeFormat = void 0, t.timeParse = void 0, t.utcFormat = void 0, t.utcParse = void 0, t_({
    dateTime: "%x, %X",
    date: "%-m/%-d/%Y",
    time: "%-I:%M:%S %p",
    periods: ["AM", "PM"],
  ...
  function c_(t, n, e, r, i, o, a, u, c, f) {
    ...
    return s.invert = function (t) {
      ...
      var e = h();
      return t && "function" == typeof t.range || (t = n(e[0], e[e.length - 1], null == t ? 10 : t)), t ? h(Yp(e, t)) : s;
    }, s.copy = function () {
      return Fp(s, c_(t, n, e, r, i, o, a, u, c, f));
    }, s;
  }
  ...
  function f_() {
    ...
    }, f.range = s(Cr), f.rangeRound = s(Pr), f.unknown = function (t) {
  ...
  function h_() {
    ...
    function p(t) {
      return function (n) {
        ...
        var e, r, i;
        return arguments.length ? ((_n58 = n, _n59 = _slicedToArray(_n58, 3), e = _n59[0], r = _n59[1], i = _n59[2], _n58), l = Zr(t, [e, r, i]), d) : [l(0), l(.5), l(1)];
      };
    }
    ...
    }, d.range = p(Cr), d.rangeRound = p(Pr), d.unknown = function (t) {
  ...
  var g_ = p_("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
    ...
    return br(t[t.length - 1]);
      ...
      D_ = T_(z_),
      q_ = new Array(3).concat("ef8a62f7f7f767a9cf", "ca0020f4a58292c5de0571b0", "ca0020f4a582f7f7f792c5de0571b0", "b2182bef8a62fddbc7d1e5f067a9cf2166ac", "b2182bef8a62fddbc7f7f7f7d1e5f067a9cf2166ac", "b2182bd6604df4a582fddbc7d1e5f092c5de4393c32166ac", "b2182bd6604df4a582fddbc7f7f7f7d1e5f092c5de4393c32166ac", "67001fb2182bd6604df4a582fddbc7d1e5f092c5de4393c32166ac053061", "67001fb2182bd6604df4a582fddbc7f7f7f7d1e5f092c5de4393c32166ac053061").map(p_),
      R_ = T_(q_),
  ...
  function rm(t, n, e, r, i, o, a, u) {
    var c = e - t,
        ...
        l = u - o,
        h = l * c - s * f;
    if (!(h * h < Gb)) return [t + (h = (s * (n - o) - l * (t - i)) / h) * c, n + h * f];
  }
  ...
  function lm(t, n) {
    ...
    return t = "function" == typeof t ? t : void 0 === t ? fm : Ub(t), n = "function" == typeof n ? n : void 0 === n ? sm : Ub(n), a.x = function (n) {
      return arguments.length ? (t = "function" == typeof n ? n : Ub(+n), a) : t;
    }, a.y = function (t) {
      return arguments.length ? (n = "function" == typeof t ? t : Ub(+t), a) : n;
    }, a.defined = function (t) {
      return arguments.length ? (e = "function" == typeof t ? t : Ub(!!t), a) : e;
    }, a.curve = function (t) {
  ...
  function hm(t, n, e) {
    ...
    return t = "function" == typeof t ? t : void 0 === t ? fm : Ub(+t), n = "function" == typeof n ? n : Ub(void 0 === n ? 0 : +n), e = "function" == typeof e ? e : void 0 === e ? sm : Ub(+e), c.x = function (n) {
      return arguments.length ? (t = "function" == typeof n ? n : Ub(+n), r = null, c) : t;
    }, c.x0 = function (n) {
      return arguments.length ? (t = "function" == typeof n ? n : Ub(+n), c) : t;
    }, c.x1 = function (t) {
      return arguments.length ? (r = null == t ? null : "function" == typeof t ? t : Ub(+t), c) : r;
    }, c.y = function (t) {
      return arguments.length ? (n = "function" == typeof t ? t : Ub(+t), e = null, c) : n;
    }, c.y0 = function (t) {
      return arguments.length ? (n = "function" == typeof t ? t : Ub(+t), c) : n;
    }, c.y1 = function (t) {
      return arguments.length ? (e = null == t ? null : "function" == typeof t ? t : Ub(+t), c) : e;
      ...
      return arguments.length ? (i = "function" == typeof t ? t : Ub(!!t), c) : i;
    }, c.curve = function (t) {
  ...
  function Am(t) {
    ...
    function a() {
      var a,
          ...
          c = n.apply(this, u),
          f = e.apply(this, u);
      if (o || (o = a = ya()), t(o, +r.apply(this, (u[0] = c, u)), +i.apply(this, u), +r.apply(this, (u[0] = f, u)), +i.apply(this, u)), a) return o = null, a + "" || null;
    }
    ...
    return a.source = function (t) {
      ...
      return arguments.length ? (r = "function" == typeof t ? t : Ub(+t), a) : r;
    }, a.y = function (t) {
      return arguments.length ? (i = "function" == typeof t ? t : Ub(+t), a) : i;
    }, a.context = function (t) {
  ...
  var km = {
    ...
    draw: function draw(t, n) {
      ...
      zm = {
    draw: function draw(t, n) {
      var e = Math.sqrt(n / Pm),
          r = e * Cm;
      t.moveTo(0, -e), t.lineTo(r, 0), t.lineTo(0, e), t.lineTo(-r, 0), t.closePath();
    }
  },
      Dm = Math.sin(Vb / 10) / Math.sin(7 * Vb / 10),
      qm = Math.sin(Wb / 10) * Dm,
      Rm = -Math.cos(Wb / 10) * Dm,
      Fm = {
    draw: function draw(t, n) {
    ...
    draw: function draw(t, n) {
      ...
      Im = {
    draw: function draw(t, n) {
      var e = -Math.sqrt(n / (3 * Um));
      t.moveTo(0, 2 * e), t.lineTo(-Um * e, -e), t.lineTo(Um * e, -e), t.closePath();
    }
  },
      Bm = -.5,
      Ym = Math.sqrt(3) / 2,
    ...
    draw: function draw(t, n) {
      var e = Math.sqrt(n / jm),
          ...
          u = -o,
          c = a;
      t.moveTo(r, i), t.lineTo(o, a), t.lineTo(u, c), t.lineTo(Bm * r - Ym * i, Ym * r + Bm * i), t.lineTo(Bm * o - Ym * a, Ym * o + Bm * a), t.lineTo(Bm * u - Ym * c, Ym * u + Bm * c), t.lineTo(Bm * r + Ym * i, Bm * i - Ym * r), t.lineTo(Bm * o + Ym * a, Bm * a - Ym * o), t.lineTo(Bm * u + Ym * c, Bm * c - Ym * u), t.closePath();
    }
  },
      Xm = [km, Nm, zm, Om, Fm, Im, Hm];
  ...
  function Qm(t, n) {
    this._basis = new $m(t), this._beta = n;
  }
  ...
  var fx = function t(n) {
    function e(t) {
      return n ? new cx(t, n) : new nx(t, 0);
    }
  ...
  var lx = function t(n) {
    function e(t) {
      return n ? new sx(t, n) : new rx(t, 0);
    }
  ...
  var dx = function t(n) {
    function e(t) {
      return n ? new hx(t, n) : new ox(t, 0);
    }
  ...
  function yx(t, n, e) {
    var r = t._x1 - t._x0,
        ...
        a = (e - t._y1) / (i || r < 0 && -0),
        u = (o * i + a * r) / (r + i);
    return (gx(o) + gx(a)) * Math.min(Math.abs(o), Math.abs(a), .5 * Math.abs(u)) || 0;
  }
  ...
  px.prototype = {
    ...
    lineEnd: function lineEnd() {
      switch (this._point) {
        ...
        case 3:
          _x(this, this._t0, vx(this, this._t0));
    ...
    point: function point(t, n) {
      ...
      if (n = +n, (t = +t) !== this._x1 || n !== this._y1) {
        switch (this._point) {
          ...
          case 2:
            this._point = 3, _x(this, vx(this, e = yx(this, t, n)), e);
            break;

          default:
            _x(this, this._t0, e = yx(this, t, n));
  ...
  }, (mx.prototype = Object.create(bx.prototype)).point = function (t, n) {
    bx.prototype.point.call(this, n, t);
  }, xx.prototype = {
    moveTo: function moveTo(t, n) {
    ...
    lineEnd: function lineEnd() {
      var t = this._x,
          n = this._y,
          e = t.length;
      if (e) if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]);else for (var r = Mx(t), i = Mx(n), o = 0, a = 1; a < e; ++o, ++a) {
  ...
  var Dx = function Dx(t) {
    return function () {
      return t;
    };
  };

  function qx(t, _ref14) {
    var n = _ref14.sourceEvent,
        e = _ref14.target,
        r = _ref14.transform,
        i = _ref14.dispatch;
    Object.defineProperties(this, {
  ...
  Rx.prototype = {
    ...
    scale: function scale(t) {
      return 1 === t ? this : new Rx(this.k * t, this.x, this.y);
    },
    translate: function translate(t, n) {
      return 0 === t & 0 === n ? this : new Rx(this.k, this.x + this.k * t, this.y + this.k * n);
    },
  ...
  Ox.prototype = Rx.prototype, t.Adder = y, t.Delaunay = gu, t.FormatSpecifier = xc, t.InternMap = InternMap, t.InternSet = InternSet, t.Node = pd, t.Voronoi = fu, t.ZoomTransform = Rx, t.active = function (t, n) {
    var e,
        r,
        i = t.__transition;
    if (i) for (r in n = null == n ? null : n + "", i) {
      if ((e = i[r]).state > 1 && e.name === n) return new Zi([[t]], To, n, +r);
    }
    return null;
  }, t.arc = function () {
    var t = Qb,
    ...
    function c() {
      var c,
          ...
          h = i.apply(this, arguments) - $b,
          d = o.apply(this, arguments) - $b,
          p = Ib(d - h),
          g = d > h;
      if (u || (u = c = ya()), l < s && (f = l, l = s, s = f), l > Gb) {
        if (p > Wb - Gb) u.moveTo(l * Yb(h), l * Hb(h)), u.arc(0, 0, l, h, d, !g), s > Gb && (u.moveTo(s * Yb(d), s * Hb(d)), u.arc(0, 0, s, d, h, g));else {
          var y,
              v,
              _ = h,
              b = d,
              ...
              T = A > Gb && (r ? +r.apply(this, arguments) : Xb(s * s + l * l)),
              S = jb(Ib(l - s) / 2, +e.apply(this, arguments)),
              E = S,
              k = S;
          ...
          if (T > Gb) {
            var N = Kb(T / s * Hb(A)),
                C = Kb(T / l * Hb(A));
            (w -= 2 * N) > Gb ? (m += N *= g ? 1 : -1, x -= N) : (w = 0, m = x = (h + d) / 2), (M -= 2 * C) > Gb ? (_ += C *= g ? 1 : -1, b -= C) : (M = 0, _ = b = (h + d) / 2);
          }
          ...
          if (S > Gb) {
            ...
            if (p < Vb && (R = rm(P, z, U, I, F, O, D, q))) {
              var B = P - R[0],
                  Y = z - R[1],
                  L = F - R[0],
                  j = O - R[1],
                  H = 1 / Hb(Zb((B * L + Y * j) / (Xb(B * B + Y * Y) * Xb(L * L + j * j))) / 2),
                  X = Xb(R[0] * R[0] + R[1] * R[1]);
              E = jb(S, (s - X) / (H - 1)), k = jb(S, (l - X) / (H + 1));
            }
          }
    ...
    return c.centroid = function () {
      ...
      return arguments.length ? (e = "function" == typeof t ? t : Ub(+t), c) : e;
    }, c.padRadius = function (t) {
      return arguments.length ? (r = null == t ? null : "function" == typeof t ? t : Ub(+t), c) : r;
    }, c.startAngle = function (t) {
      return arguments.length ? (i = "function" == typeof t ? t : Ub(+t), c) : i;
    }, c.endAngle = function (t) {
      return arguments.length ? (o = "function" == typeof t ? t : Ub(+t), c) : o;
    }, c.padAngle = function (t) {
      return arguments.length ? (a = "function" == typeof t ? t : Ub(+t), c) : a;
    }, c.context = function (t) {
      return arguments.length ? (u = null == t ? null : t, c) : u;
    }, c;
  }, t.area = hm, t.areaRadial = mm, t.ascending = n, t.autoType = function (t) {
    for (var n in t) {
      var e,
          r,
          i = t[n].trim();
      if (i) {
        if ("true" === i) i = !0;else if ("false" === i) i = !1;else if ("NaN" === i) i = NaN;else if (isNaN(e = +i)) {
          ...
          Iu && r[4] && !r[7] && (i = i.replace(/-/g, "/").replace(/T/, " ")), i = new Date(i);
        } else i = e;
      } else i = null;
      t[n] = i;
    }
    ...
    return yt(1, t);
  }, t.bin = j, t.bisect = c, t.bisectCenter = u, t.bisectLeft = a, t.bisectRight = o, t.bisector = e, t.blob = function (t, n) {
  ...
  }, t.color = me, t.contourDensity = function () {
    var t = Ua,
        n = Ia,
        e = Ba,
        r = 960,
    ...
    function l(r) {
      ...
      if (!Array.isArray(p)) {
        var g = H(i);
        p = B(0, g, p), (p = tt(0, Math.floor(g / p) * p, p)).shift();
      }
    ...
    return l.x = function (n) {
      return arguments.length ? (t = "function" == typeof n ? n : Na(+n), l) : t;
    }, l.y = function (t) {
      return arguments.length ? (n = "function" == typeof t ? t : Na(+t), l) : n;
    }, l.weight = function (t) {
      return arguments.length ? (e = "function" == typeof t ? t : Na(+t), l) : e;
    }, l.size = function (t) {
      ...
      return arguments.length ? (s = "function" == typeof t ? t : Array.isArray(t) ? Na(Ea.call(t)) : Na(t), l) : s;
  ...
  }, t.contours = Ra, t.count = f, t.create = function (t) {
    return Un(kt(t).call(document.documentElement));
  }, t.creator = kt, t.cross = function () {
  ...
  }, t.csv = Xu, t.csvFormat = Su, t.csvFormatBody = Eu, t.csvFormatRow = Nu, t.csvFormatRows = ku, t.csvFormatValue = Cu, t.csvParse = Au, t.csvParseRows = Tu, t.cubehelix = ur, t.cumsum = function (t, n) {
    var e = 0,
        r = 0;
    ...
    return new Km(t, !1);
  }, t.curveBundle = Jm, t.curveCardinal = ex, t.curveCardinalClosed = ix, t.curveCardinalOpen = ax, t.curveCatmullRom = fx, t.curveCatmullRomClosed = lx, t.curveCatmullRomOpen = dx, t.curveLinear = cm, t.curveLinearClosed = function (t) {
    return new px(t);
    ...
    try {
      for (_iterator38.s(); !(_step38 = _iterator38.n()).done;) {
        ...
        for (; (_e$next2 = e.next(), _t31 = _e$next2.value, _i26 = _e$next2.done, _e$next2) && !_i26;) {
          var _e$next2;

          if (Object.is(_n62, _t31)) return !1;
          r.add(_t31);
        }
      }
    } catch (err) {
    ...
    function d(a, u) {
      if (!r && i.call(this, a, u)) {
        ...
        c && (Un(a.view).on("mousemove.drag", p, Xn).on("mouseup.drag", g, Xn), $n(a.view), Gn(a), e = !1, t = a.clientX, n = a.clientY, c("start", a));
      }
    }
    ...
    function g(t) {
      Un(t.view).on("mousemove.drag mouseup.drag", null), Wn(t.view, e), Vn(t), c.mouse("end", t);
    }
    ...
    function y(t, n) {
      if (i.call(this, t, n)) {
        ...
        for (e = 0; e < c; ++e) {
          (r = b(this, u, t, n, a[e].identifier, a[e])) && (Gn(t), r("start", t, a[e]));
        }
      }
    }
    ...
    function v(t) {
      ...
      for (n = 0; n < i; ++n) {
        (e = c[r[n].identifier]) && (Vn(t), e("drag", t, r[n]));
      }
    }
    ...
    return h.filter = function (t) {
      return arguments.length ? (i = "function" == typeof t ? t : Zn(!!t), h) : i;
    }, h.container = function (t) {
      return arguments.length ? (o = "function" == typeof t ? t : Zn(t), h) : o;
    }, h.subject = function (t) {
      return arguments.length ? (a = "function" == typeof t ? t : Zn(t), h) : a;
    }, h.touchable = function (t) {
      return arguments.length ? (u = "function" == typeof t ? t : Zn(!!t), h) : u;
    }, h.on = function () {
  ...
  }, t.dragDisable = $n, t.dragEnable = Wn, t.dsv = function (t, n, e, r) {
    3 === arguments.length && "function" == typeof e && (r = e, e = void 0);
    var i = wu(t);
    return ju(n, e).then(function (t) {
      return i.parse(t, r);
    });
  }, t.dsvFormat = wu, t.easeBack = _o, t.easeBackIn = yo, t.easeBackInOut = _o, t.easeBackOut = vo, t.easeBounce = po, t.easeBounceIn = function (t) {
    return 1 - po(1 - t);
  }, t.easeBounceInOut = function (t) {
    return ((t *= 2) <= 1 ? 1 - po(1 - t) : po(t - 1) + 1) / 2;
  }, t.easeBounceOut = po, t.easeCircle = so, t.easeCircleIn = function (t) {
    return 1 - Math.sqrt(1 - t * t);
  }, t.easeCircleInOut = so, t.easeCircleOut = function (t) {
    return Math.sqrt(1 - --t * t);
  }, t.easeCubic = no, t.easeCubicIn = function (t) {
    return t * t * t;
  }, t.easeCubicInOut = no, t.easeCubicOut = function (t) {
    return --t * t * t + 1;
  }, t.easeElastic = xo, t.easeElasticIn = mo, t.easeElasticInOut = wo, t.easeElasticOut = xo, t.easeExp = fo, t.easeExpIn = function (t) {
    return co(1 - +t);
  }, t.easeExpInOut = fo, t.easeExpOut = function (t) {
    return 1 - co(t);
  }, t.easeLinear = function (t) {
    return +t;
  }, t.easePoly = io, t.easePolyIn = eo, t.easePolyInOut = io, t.easePolyOut = ro, t.easeQuad = to, t.easeQuadIn = function (t) {
    return t * t;
  }, t.easeQuadInOut = to, t.easeQuadOut = function (t) {
    return t * (2 - t);
  }, t.easeSin = uo, t.easeSinIn = function (t) {
    return 1 == +t ? 1 : 1 - Math.cos(t * ao);
  }, t.easeSinInOut = uo, t.easeSinOut = function (t) {
    ...
    return A(M.apply(void 0, [t].concat(n)), n);
    ...
    return A(S.apply(void 0, [t, n].concat(e)), e);
    ...
    function a() {
      for (var t, a, c, f, s, l, h, d = n.length, p = 0; p < o; ++p) {
        for (a = ec(n, cc, fc).visitAfter(u), t = 0; t < d; ++t) {
    ...
    function h() {
      if (r) {
        ...
        for (a = 0, i = new Array(f); a < s; ++a) {
          (c = t[a]).index = a, "object" != _typeof(c.source) && (c.source = lc(l, c.source)), "object" != _typeof(c.target) && (c.target = lc(l, c.target)), i[c.source.index] = (i[c.source.index] || 0) + 1, i[c.target.index] = (i[c.target.index] || 0) + 1;
        }
  ...
  }, t.formatDefaultLocale = Nc, t.formatLocale = kc, t.formatSpecifier = mc, t.fsum = function (t, n) {
    var e = new y();
    ...
    return s.invert = function (t) {
      ...
      var n = a.scale(),
          o = +t[0],
          s = +t[1];
      return e = a.translate(t).clipExtent([[o - .455 * n, s - .238 * n], [o + .455 * n, s + .238 * n]]).stream(f), r = u.translate([o - .307 * n, s + .201 * n]).clipExtent([[o - .425 * n + Dc, s + .12 * n + Dc], [o - .214 * n - Dc, s + .234 * n - Dc]]).stream(f), i = c.translate([o - .205 * n, s + .212 * n]).clipExtent([[o - .214 * n + Dc, s + .166 * n + Dc], [o - .115 * n - Dc, s + .234 * n - Dc]]).stream(f), l();
    ...
    if (bf = _f = -(yf = vf = 1 / 0), Tf = [], sf(t, rs), e = Tf.length) {
      for (Tf.sort(hs), n = 1, o = [r = Tf[0]]; n < e; ++n) {
        ds(r, (i = Tf[n])[0]) || ds(r, i[1]) ? (ls(r[0], i[1]) > ls(r[0], r[1]) && (r[1] = i[1]), ls(i[0], r[1]) > ls(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
      }

      for (a = -1 / 0, n = 0, r = o[e = o.length - 1]; n <= e; r = i, ++n) {
        i = o[n], (u = ls(r[1], i[0])) > a && (a = u, yf = i[0], _f = r[1]);
      }
    }

    return Tf = Sf = null, yf === 1 / 0 || vf === 1 / 0 ? [[NaN, NaN], [NaN, NaN]] : [[yf, vf], [_f, bf]];
  }, t.geoCentroid = function (t) {
    Yf = Lf = jf = Hf = Xf = Gf = Vf = $f = 0, Wf = new y(), Zf = new y(), Kf = new y(), sf(t, ps);
    var n = +Wf,
        e = +Zf,
        r = +Kf,
        i = Vc(n, e, r);
    return i < qc && (n = Gf, e = Vf, r = $f, Lf < Dc && (n = jf, e = Hf, r = Xf), (i = Vc(n, e, r)) < qc) ? [NaN, NaN] : [jc(e, n) * Ic, nf(r / i) * Ic];
    ...
    function a() {
      ...
      return t = [], n = ks(-a[0] * Bc, -a[1] * Bc, 0).invert, Ds(o, u, c, 1), a = {
        type: "Polygon",
        coordinates: [t]
      }, t = n = null, a;
    }
    ...
    return a.center = function (t) {
      return arguments.length ? (e = "function" == typeof t ? t : Ts([+t[0], +t[1]]), a) : e;
    }, a.radius = function (t) {
      return arguments.length ? (r = "function" == typeof t ? t : Ts(+t), a) : r;
    }, a.precision = function (t) {
      return arguments.length ? (i = "function" == typeof t ? t : Ts(+t), a) : i;
    }, a;
  }, t.geoClipAntimeridian = Xs, t.geoClipCircle = Gs, t.geoClipExtent = function () {
    var t,
        n,
        e,
        r = 0,
  ...
  }, t.geoClipRectangle = Js, t.geoConicConformal = function () {
  ...
  }, t.geoDistance = ul, t.geoEqualEarth = function () {
  ...
  }, t.geoGnomonicRaw = td, t.geoGraticule = _l, t.geoGraticule10 = function () {
    return _l()();
    ...
    return b.invert = function (e) {
      ...
      return arguments.length ? (v = null == t ? (d = e = r = i = null, Ml) : Js(d = +t[0][0], e = +t[0][1], r = +t[1][0], i = +t[1][1]), _()) : null == d ? null : [[d, e], [r, i]];
    }, b.scale = function (t) {
      return arguments.length ? (u = +t, _()) : u;
    }, b.translate = function (t) {
      return arguments.length ? (c = +t[0], f = +t[1], _()) : [c, f];
    }, b.angle = function (e) {
      return arguments.length ? (n = Zc(h = e % 360 * Bc), t = Hc(h), _()) : h * Ic;
  ...
  }, t.geoLength = il, t.geoMercator = function () {
    ...
    function o(t) {
      return t && ("function" == typeof i && r.pointRadius(+i.apply(this, arguments)), sf(t, e(r))), r.result();
    }

    return o.area = function (t) {
      return sf(t, e(Pl)), Pl.result();
    }, o.measure = function (t) {
      return sf(t, e(_h)), _h.result();
    }, o.bounds = function (t) {
      return sf(t, e(Yl)), Yl.result();
    }, o.centroid = function (t) {
      return sf(t, e(uh)), uh.result();
    }, o.projection = function (n) {
      return arguments.length ? (e = null == n ? (t = null, Ml) : (t = n).stream, o) : t;
  ...
  }, t.geoProjection = zh, t.geoProjectionMutator = Dh, t.geoRotation = zs, t.geoStereographic = function () {
    return zh(rd).scale(250).clipAngle(142);
  }, t.geoStereographicRaw = rd, t.geoStream = sf, t.geoTransform = function (t) {
    return {
      stream: xh(t)
    };
    ...
    if (1 === e.length) {
      ...
      try {
        for (_iterator43.s(); !(_step43 = _iterator43.n()).done;) {
          ...
          (i ? n(_t32, _o23) > 0 : 0 === n(_t32, _t32)) && (r = _a20, _o23 = _t32, i = !0);
        }
      } catch (err) {
        _iterator43.e(err);
      } finally {
    ...
    return i;
  }, t.group = w, t.groupSort = function (t, e, r) {
    return (2 !== e.length ? C(T(t, e, r), function (_ref15, _ref16) {
      ...
      return n(e, i) || n(t, r);
    }) : C(w(t, r), function (_ref19, _ref20) {
  ...
  }, t.groups = M, t.hcl = We, t.hierarchy = fd, t.histogram = j, t.hsl = Pe, t.html = Zu, t.image = function (t, n) {
  ...
  }, t.interpolate = Cr, t.interpolateArray = function (t, n) {
    return (wr(n) ? xr : Mr)(t, n);
  }, t.interpolateBasis = sr, t.interpolateBasisClosed = lr, t.interpolateBlues = gb, t.interpolateBrBG = E_, t.interpolateBuGn = X_, t.interpolateBuPu = V_, t.interpolateCividis = function (t) {
  ...
  }, t.interpolateCool = kb, t.interpolateCubehelix = $r, t.interpolateCubehelixDefault = Sb, t.interpolateCubehelixLong = Wr, t.interpolateDate = Ar, t.interpolateDiscrete = function (t) {
    var n = t.length;
    return function (e) {
      return t[Math.max(0, Math.min(n - 1, Math.floor(e * n)))];
    };
  }, t.interpolateGnBu = W_, t.interpolateGreens = vb, t.interpolateGreys = bb, t.interpolateHcl = Xr, t.interpolateHclLong = Gr, t.interpolateHsl = Lr, t.interpolateHslLong = jr, t.interpolateHue = function (t, n) {
    var e = pr(+t, +n);
    return function (t) {
      var n = e(t);
      return n - 360 * Math.floor(n / 360);
    };
  }, t.interpolateInferno = Fb, t.interpolateLab = function (t, n) {
    ...
    var n = Math.abs(t - .5);
    return Nb.h = 360 * t - 100, Nb.s = 1.5 - 1.5 * n, Nb.l = .8 - .9 * n, Nb + "";
  }, t.interpolateRdBu = R_, t.interpolateRdGy = O_, t.interpolateRdPu = ob, t.interpolateRdYlBu = I_, t.interpolateRdYlGn = Y_, t.interpolateReds = Mb, t.interpolateRgb = vr, t.interpolateRgbBasis = br, t.interpolateRgbBasisClosed = mr, t.interpolateRound = Pr, t.interpolateSinebow = function (t) {
    var n;
    return t = (.5 - t) * Math.PI, Cb.r = 255 * (n = Math.sin(t)) * n, Cb.g = 255 * (n = Math.sin(t + Pb)) * n, Cb.b = 255 * (n = Math.sin(t + zb)) * n, Cb + "";
  }, t.interpolateSpectral = j_, t.interpolateString = Nr, t.interpolateTransformCss = Or, t.interpolateTransformSvg = Ur, t.interpolateTurbo = function (t) {
  ...
  }, t.interpolateViridis = qb, t.interpolateWarm = Eb, t.interpolateYlGn = fb, t.interpolateYlGnBu = ub, t.interpolateYlOrBr = lb, t.interpolateYlOrRd = db, t.interpolateZoom = Br, t.interrupt = wi, t.intersection = function (t) {
    for (var _len12 = arguments.length, n = new Array(_len12 > 1 ? _len12 - 1 : 0), _key12 = 1; _key12 < _len12; _key12++) {
      n[_key12 - 1] = arguments[_key12];
    }

    t = new InternSet(t), n = n.map(at);
    ...
    return null == n ? (r.restart(t, n, e), r) : (r._restart = r.restart, r.restart = function (t, n, e) {
      n = +n, e = null == e ? ui() : +e, r._restart(function o(a) {
        a += i, r._restart(o, i += n, e), t(a);
      }, n, e);
    }, r.restart(t, n, e), r);
  }, t.isoFormat = r_, t.isoParse = o_, t.json = function (t, n) {
    return fetch(t, n).then(Vu);
  }, t.lab = Le, t.lch = function (t, n, e, r) {
    ...
    if (1 === e.length) {
      ...
      try {
        for (_iterator48.s(); !(_step48 = _iterator48.n()).done;) {
          ...
          (i ? n(_t33, _o24) < 0 : 0 === n(_t33, _t33)) && (r = _a21, _o24 = _t33, i = !0);
        }
      } catch (err) {
        _iterator48.e(err);
      } finally {
    ...
    return r;
  }, t.leastIndex = nt, t.line = lm, t.lineRadial = bm, t.linkHorizontal = function () {
    return Am(Tm);
    ...
    if (void 0 === n) {
      ...
      try {
        for (_iterator51.s(); !(_step51 = _iterator51.n()).done;) {
          var _o25 = _step51.value;
          null != (_o25 = n(_o25, ++_i29, t)) && (_o25 = +_o25) >= _o25 && (++e, r += _o25);
        }
      } catch (err) {
        _iterator51.e(err);
      } finally {
    ...
    return $(t, .5, n);
  }, t.merge = K, t.min = X, t.minIndex = Q, t.mode = function (t, n) {
    var e = new InternMap();
    ...
    try {
      for (_iterator54.s(); !(_step54 = _iterator54.n()).done;) {
        var _step54$value = _slicedToArray(_step54.value, 2),
            _t34 = _step54$value[0],
            _n69 = _step54$value[1];

        _n69 > i && (i = _n69, r = _t34);
      }
    } catch (err) {
      _iterator54.e(err);
    } finally {
    ...
    return r;
  }, t.namespace = Tt, t.namespaces = At, t.nice = Y, t.now = ui, t.pack = function () {
    var t = null,
        n = 1,
        e = 1,
        r = Cd;
    ...
    var n = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : J;
    var e = [];
    var r,
        i = !1;
    ...
    try {
      for (_iterator55.s(); !(_step55 = _iterator55.n()).done;) {
        var _o26 = _step55.value;
        i && e.push(n(r, _o26)), r = _o26, i = !0;
      }
    } catch (err) {
      _iterator55.e(err);
    } finally {
  ...
  }, t.path = ya, t.permute = N, t.pie = function () {
    var t = pm,
        n = dm,
        e = null,
        r = Ub(0),
    ...
    function a(a) {
      var u,
          ...
          v = Math.min(Wb, Math.max(-Wb, i.apply(this, arguments) - y)),
    ...
    return a.value = function (n) {
      ...
      return arguments.length ? (o = "function" == typeof t ? t : Ub(+t), a) : o;
    }, a;
  }, t.piecewise = Zr, t.pointRadial = xm, t.pointer = jn, t.pointers = function (t, n) {
    return t.target && (t = Ln(t), void 0 === n && (n = t.currentTarget), t = t.touches || [t]), Array.from(t, function (t) {
      return jn(t, n);
    });
    ...
    return c;
  }, t.precisionFixed = Cc, t.precisionPrefix = Pc, t.precisionRound = zc, t.quadtree = ec, t.quantile = $, t.quantileSorted = W, t.quantize = function (t, n) {
    for (var e = new Array(n), r = 0; r < n; ++r) {
      e[r] = t(r / (n - 1));
    }

    return e;
  }, t.quickselect = G, t.radialArea = mm, t.radialLine = bm, t.randomBates = lp, t.randomBernoulli = pp, t.randomBeta = vp, t.randomBinomial = _p, t.randomCauchy = mp, t.randomExponential = hp, t.randomGamma = yp, t.randomGeometric = gp, t.randomInt = up, t.randomIrwinHall = sp, t.randomLcg = function () {
  ...
  }, t.randomLogNormal = fp, t.randomLogistic = xp, t.randomNormal = cp, t.randomPareto = dp, t.randomPoisson = wp, t.randomUniform = ap, t.randomWeibull = bp, t.range = tt, t.rank = function (t) {
    var e = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : n;
    if ("function" != typeof t[Symbol.iterator]) throw new TypeError("values is not iterable");
    var r = Array.from(t);
    var i = new Float64Array(r.length);
    ...
    var a, u;
    return Uint32Array.from(r, function (t, n) {
      return n;
    }).sort(e === n ? function (t, n) {
      return z(r[t], r[n]);
    } : P(o)).forEach(function (t, n) {
      var e = o(t, void 0 === a ? t : a);
  ...
  }, t.rgb = Ae, t.ribbon = function () {
    return Sa();
  }, t.ribbonArrow = function () {
    return Sa(Ta);
  }, t.rollup = T, t.rollups = S, t.scaleBand = kp, t.scaleDiverging = function t() {
    var n = Bp(h_()(zp));
  ...
  }, t.scaleDivergingPow = d_, t.scaleDivergingSqrt = function () {
    ...
    return r.invert = r, r.domain = r.range = function (t) {
      return arguments.length ? (n = Array.from(t, Cp), r) : n.slice();
    }, r.unknown = function (t) {
      return arguments.length ? (e = t, r) : e;
    }, r.copy = function () {
      return t(n).unknown(e);
    }, n = arguments.length ? Array.from(n, Cp) : [0, 1], Bp(r);
  }, t.scaleImplicit = Sp, t.scaleLinear = function t() {
    var n = Up();
    return n.copy = function () {
      return Fp(n, t());
    }, Ap.apply(n, arguments), Bp(n);
  }, t.scaleLog = function t() {
    var n = $p(Op()).domain([1, 10]);
    return n.copy = function () {
      return Fp(n, t()).base(n.base());
    }, Ap.apply(n, arguments), n;
  }, t.scaleOrdinal = Ep, t.scalePoint = function () {
    ...
    return u.domain = function (t) {
      ...
      return arguments.length ? ((_t35 = t, _t36 = _slicedToArray(_t35, 2), e = _t36[0], r = _t36[1], _t35), e = +e, r = +r, f()) : [e, r];
    }, u.range = function (t) {
    ...
    return o.invert = function (t) {
      ...
      return arguments.length ? (e.range((r = Array.from(t, Cp)).map(rg)), o) : r.slice();
    ...
    var n = Kp(Op());
    return n.copy = function () {
      return Fp(n, t()).constant(n.constant());
    ...
    function i(i) {
      var o,
          a,
          u = Array.from(t.apply(this, arguments), kx),
          c = u.length,
          f = -1;
      ...
      try {
        for (_iterator59.s(); !(_step59 = _iterator59.n()).done;) {
          ...
          for (o = 0, ++f; o < c; ++o) {
            (u[o][f] = [0, +r(_t37, u[o].key, f, i)]).data = _t37;
          }
        }
      } catch (err) {
        _iterator59.e(err);
    ...
    return i.keys = function (n) {
      return arguments.length ? (t = "function" == typeof n ? n : Ub(Array.from(n)), i) : t;
    }, i.value = function (t) {
      return arguments.length ? (r = "function" == typeof t ? t : Ub(+t), i) : r;
    }, i.order = function (t) {
      return arguments.length ? (n = null == t ? Sx : "function" == typeof t ? t : Ub(Array.from(t)), i) : n;
    }, i.offset = function (t) {
      return arguments.length ? (e = null == t ? Tx : t, i) : e;
    }, i;
  ...
  }, t.stackOffsetNone = Tx, t.stackOffsetSilhouette = function (t, n) {
    if ((e = t.length) > 0) {
    ...
    if ((i = t.length) > 0 && (r = (e = t[n[0]]).length) > 0) {
      ...
      e[a - 1][1] += e[a - 1][0] = o, Tx(t, n);
    }
  }, t.stackOrderAppearance = Nx, t.stackOrderAscending = Px, t.stackOrderDescending = function (t) {
    return Px(t).reverse();
  ...
  }, t.stackOrderNone = Sx, t.stackOrderReverse = function (t) {
    return Sx(t).reverse();
  }, t.stratify = function () {
    var t,
        n = Yd,
    ...
    function r(r) {
      ...
      if (null != t) {
        var _n72 = h.map(function (n, e) {
          return function (t) {
            var n = (t = "".concat(t)).length;
            Hd(t, n - 1) && !Hd(t, n - 2) && (t = t.slice(0, -1));
            return "/" === t[0] ? t : "/".concat(t);
          }(t(n, e, r));
        }),
            _e37 = _n72.map(jd),
            _i31 = new Set(_n72).add("");

        var _iterator60 = _createForOfIteratorHelper(_e37),
            _step60;

        try {
          for (_iterator60.s(); !(_step60 = _iterator60.n()).done;) {
            var _t38 = _step60.value;
            _i31.has(_t38) || (_i31.add(_t38), _n72.push(_t38), _e37.push(jd(_t38)), h.push(Bd));
          }
        } catch (err) {
          _iterator60.e(err);
        } finally {
      ...
      for (a = 0, i = h.length; a < i; ++a) {
        o = h[a], f = h[a] = new pd(o), null != (s = d(o, a, r)) && (s += "") && (l = f.id = s, g.set(l, g.has(l) ? Id : f)), null != (s = p(o, a, r)) && (s += "") && (f.parent = s);
      }

      for (a = 0; a < i; ++a) {
        if (s = (f = h[a]).parent) {
          if (!(c = g.get(s))) throw new Error("missing: " + s);
          if (c === Id) throw new Error("ambiguous: " + s);
      ...
      if (null != t) {
        ...
        for (var _t39 = h.length - 1; _t39 >= 0 && (f = h[_t39], f.data === Bd); --_t39) {
          f.data = null;
        }
      }

      if (u.parent = Ud, u.eachBefore(function (t) {
        t.depth = t.parent.depth + 1, --i;
      }).eachBefore(dd), u.parent = null, i > 0) throw new Error("cycle");
      return u;
    }
  ...
  }, t.style = on, t.subset = function (t, n) {
    return ut(n, t);
  }, t.sum = function (t, n) {
    var e = 0;
    ...
    if (void 0 === n) {
      ...
      try {
        for (_iterator62.s(); !(_step62 = _iterator62.n()).done;) {
          var _i32 = _step62.value;
          (_i32 = +n(_i32, ++_r41, t)) && (e += _i32);
        }
      } catch (err) {
        _iterator62.e(err);
      } finally {
    ...
    return e;
  }, t.superset = ut, t.svg = Ku, t.symbol = function (t, n) {
    var e = null;

    function r() {
      var r;
      if (e || (e = r = ya()), t.apply(this, arguments).draw(e, +n.apply(this, arguments)), r) return e = null, r + "" || null;
    }

    return t = "function" == typeof t ? t : Ub(t || km), n = "function" == typeof n ? n : Ub(void 0 === n ? 64 : +n), r.type = function (n) {
      return arguments.length ? (t = "function" == typeof n ? n : Ub(n), r) : t;
    }, r.size = function (t) {
      return arguments.length ? (n = "function" == typeof t ? t : Ub(+t), r) : n;
    }, r.context = function (t) {
      return arguments.length ? (e = null == t ? null : t, r) : e;
    }, r;
  }, t.symbolCircle = km, t.symbolCross = Nm, t.symbolDiamond = zm, t.symbolSquare = Om, t.symbolStar = Fm, t.symbolTriangle = Im, t.symbolWye = Hm, t.symbols = Xm, t.text = ju, t.thresholdFreedmanDiaconis = function (t, n, e) {
      ...
      var c = function (t) {
        for (var n, e, r, i, o, a = new Zd(t, 0), u = [a]; n = u.pop();) {
          if (r = n._.children) for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) {
            u.push(e = n.children[i] = new Zd(r[i], i)), e.parent = n;
          }
        }

        return (a.parent = new Zd(null, 0)).children = [a], a;
      }(i);
    ...
    function o(n) {
      ...
      n.parent.A = function (n, e, r) {
        if (e) {
          for (var i, o = n, a = n, u = e, c = o.parent.children[0], f = o.m, s = a.m, l = u.m, h = c.m; u = Vd(u), o = Gd(o), u && o;) {
            c = Gd(c), (a = Vd(a)).a = n, (i = u.z + l - o.z - f + t(u._, o._)) > 0 && ($d(Wd(u, n, r), n, i), f += i, s += i), l += u.m, f += o.m, h += c.m, s += a.m;
          }

          u && !Vd(a) && (a.t = u, a.m += l - s), o && !Gd(c) && (c.t = o, c.m += f - h, r = n);
        }
  ...
  }, t.treemapDice = Od, t.treemapResquarify = np, t.treemapSlice = Kd, t.treemapSliceDice = function (t, n, e, r, i) {
    (1 & t.depth ? Kd : Od)(t, n, e, r, i);
  }, t.treemapSquarify = tp, t.tsv = Gu, t.tsvFormat = qu, t.tsvFormatBody = Ru, t.tsvFormatRow = Ou, t.tsvFormatRows = Fu, t.tsvFormatValue = Uu, t.tsvParse = zu, t.tsvParseRows = Du, t.union = function () {
    var n = new InternSet();
    ...
    for (var _i33 = 0, _t40 = t; _i33 < _t40.length; _i33++) {
      var _e38 = _t40[_i33];

      var _iterator63 = _createForOfIteratorHelper(_e38),
          _step63;

      try {
        for (_iterator63.s(); !(_step63 = _iterator63.n()).done;) {
          var _t41 = _step63.value;
          n.add(_t41);
        }
      } catch (err) {
        _iterator63.e(err);
    ...
    function y(t) {
      t.property("__zoom", Lx).on("wheel.zoom", M, {
        passive: !1
    ...
    function v(t, n) {
      return (n = Math.max(c[0], Math.min(c[1], n))) === t.k ? t : new Rx(n, t.x, t.y);
    }

    function _(t, n, e) {
      var r = n[0] - e[0] * t.k,
          i = n[1] - e[1] * t.k;
      return r === t.x && i === t.y ? t : new Rx(t.k, r, i);
    }
      ...
      t.on("start.zoom", function () {
        ...
        return function (t) {
          if (1 === t) t = h;else {
            var n = d(t),
                e = f / n[2];
            t = new Rx(e, c[0] - n[0] * e, c[1] - n[1] * e);
          }
          a.zoom(null, t);
        };
      });
    ...
    function M(t) {
      ...
      if (r.apply(this, arguments)) {
        ...
        if (e.wheel) e.mouse[0][0] === s[0] && e.mouse[0][1] === s[1] || (e.mouse[1] = i.invert(e.mouse[0] = s)), clearTimeout(e.wheel);else {
          if (i.k === u) return;
          e.mouse = [s, i.invert(s)], wi(this), e.start();
        }
        Ix(t), e.wheel = setTimeout(l, 150), e.zoom("mouse", o(_(v(i, u), e.mouse[0], e.mouse[1]), e.extent, f));
      }
    ...
    function A(t) {
      ...
      if (!e && r.apply(this, arguments)) {
        var i = t.currentTarget,
            ...
            s = t.clientX,
            l = t.clientY;
        $n(t.view), Ux(t), a.mouse = [c, this.__zoom.invert(c)], wi(this), a.start();
      }
      ...
      function d(t) {
        u.on("mousemove.zoom mouseup.zoom", null), Wn(t.view, a.moved), Ix(t), a.event(t).end();
      }
    }
    ...
    function T(t) {
      ...
      if (r.apply(this, arguments)) {
        ...
        Ix(t), s > 0 ? Un(this).transition().duration(s).call(m, l, a, t) : Un(this).call(y.transform, l, a, t);
      }
    }
    ...
    function S(e) {
      ...
      if (r.apply(this, arguments)) {
        ...
        for (Ux(e), a = 0; a < s; ++a) {
          c = [c = jn(u = f[a], this), this.__zoom.invert(c), u.identifier], l.touch0 ? l.touch1 || l.touch0[2] === c[2] || (l.touch1 = c, l.taps = 0) : (l.touch0 = c, o = !0, l.taps = 1 + !!t);
        }
    ...
    function E(t) {
      if (this.__zooming) {
        ...
        for (Ix(t), e = 0; e < s; ++e) {
          i = jn(r = c[e], this), u.touch0 && u.touch0[2] === r.identifier ? u.touch0[0] = i : u.touch1 && u.touch1[2] === r.identifier && (u.touch1[0] = i);
        }
    ...
    function k(t) {
      ...
      if (this.__zooming) {
        ...
        for (Ux(t), e && clearTimeout(e), e = setTimeout(function () {
          e = null;
        }, d), i = 0; i < c; ++i) {
          o = u[i], a.touch0 && a.touch0[2] === o.identifier ? delete a.touch0 : a.touch1 && a.touch1[2] === o.identifier && delete a.touch1;
        }

        if (a.touch1 && !a.touch0 && (a.touch0 = a.touch1, delete a.touch1), a.touch0) a.touch0[1] = this.__zoom.invert(a.touch0[0]);else if (a.end(), 2 === a.taps && (o = jn(o, this), Math.hypot(n[0] - o[0], n[1] - o[1]) < g)) {
    ...
    return y.transform = function (t, n, e, r) {
      ...
      i.property("__zoom", Lx), t !== i ? m(t, n, e, r) : i.interrupt().each(function () {
      ...
      y.transform(t, function () {
        ...
        return o(Fx.translate(u[0], u[1]).scale(a.k).translate("function" == typeof n ? -n.apply(this, arguments) : -n, "function" == typeof e ? -e.apply(this, arguments) : -e), t, f);
      }, r, a);
    }, w.prototype = {
      ...
      return arguments.length ? (a = "function" == typeof t ? t : Dx(+t), y) : a;
    }, y.filter = function (t) {
      return arguments.length ? (r = "function" == typeof t ? t : Dx(!!t), y) : r;
    }, y.touchable = function (t) {
      return arguments.length ? (u = "function" == typeof t ? t : Dx(!!t), y) : u;
    }, y.extent = function (t) {
      return arguments.length ? (i = "function" == typeof t ? t : Dx([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]), y) : i;
  ...
  }, t.zoomIdentity = Fx, t.zoomTransform = Ox, Object.defineProperty(t, "__esModule", {
    value: !0
  });
});
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../node_modules/d3/dist/d3.min.js"], "script")
//# sourceMappingURL=/d3.min.1c00d1ef.js.map